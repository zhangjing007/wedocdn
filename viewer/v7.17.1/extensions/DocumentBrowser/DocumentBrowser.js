...
var Panel = /*#__PURE__*/function (_SuperClass) {_inherits(Panel, _SuperClass);
  ...
  function Panel(viewer, currNode) {var _this;_classCallCheck(this, Panel);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Panel).call(this, viewer.container, 'lmv-document-extension_' + viewer.id, 'Document Browser', { heightAdjustment: HEIGHT_ADJUSTMENT }));
