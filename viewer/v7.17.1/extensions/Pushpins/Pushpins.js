...
PushPinManager = /*#__PURE__*/function (_Autodesk$Viewing$Eve) {_inherits(PushPinManager, _Autodesk$Viewing$Eve);
  function PushPinManager(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinManager);
    ...
    _this.is2D = _this.viewer.model && _this.viewer.model.is2d();
    ...
    if (!_this.is2D) {
      ...
      _this.options.disableOcclusionTest = true;
    }
    ...
    // Update locationIds array inside the item's data.
      ...
      var locationsExtension = this.viewer.getExtension('Autodesk.AEC.LocationsExtension');

      if (locationsExtension) {
        var locations = locationsExtension.getLocations();
        ...
        if (locations) {
          ...
          var intersectedLocations = Autodesk.AEC.Locations.getPointLocations(point, locations);
          item.setLocationIds(intersectedLocations.map(function (location) {return location.id;}));
        }
      }
    }
