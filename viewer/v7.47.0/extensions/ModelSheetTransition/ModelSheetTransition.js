...
var LevelsExtensionId = 'Autodesk.AEC.LevelsExtension';var
...
ModelSheetTransitionExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(ModelSheetTransitionExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(ModelSheetTransitionExtension);
  ...
  function ModelSheetTransitionExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, ModelSheetTransitionExtension);
    ...
    } }, { key: "updateUI", value: function updateUI()

    {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$resetTransformAn = _ref.resetTransformAndViewport,resetTransformAndViewport = _ref$resetTransformAn === void 0 ? true : _ref$resetTransformAn;
      var model2D = Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_0__["getSuitable2DModel"])(this.viewer);
      ...
      if (model2D) {// A suitable 2D model is only returned in 2D mode
        ...
        var toolbarUIEnabled = this.getViewportsForModel(model2D).length > 0;
    ...
    {var _this2 = this;
      ...
      this.toolbarButton.onClick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var model;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!
                ...
                _this2.transitionStarted = false;case 14:case "end":return _context2.stop();}}}, _callee2);}));
    ...
    } }, { key: "addMarkersForModel", value: function () {var _addMarkersForModel = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(

      model) {var _this4 = this;var relatedViewports, vpKeys, keysToRemove;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (
                model.is3d()) {_context3.next = 2;break;}return _context3.abrupt("return");case 2:
                ...
                if (!this.duringModelToSheetTransition) {_context3.next = 5;break;}return _context3.abrupt("return");case 5:if (




                this.viewer.impl.findModel(model.id)) {_context3.next = 7;break;}return _context3.abrupt("return");case 7:
                ...
                // Add new markers
                relatedViewports.forEach(function (vp) {var _this4$selectedViewpo;
                  ...
                  if (((_this4$selectedViewpo = _this4.selectedViewport) === null || _this4$selectedViewpo === void 0 ? void 0 : _this4$selectedViewpo.getGuid()) === vpGuid) {
                    marker.setMarkerSelected(true);
                  }
                });case 11:case "end":return _context3.stop();}}}, _callee3, this);}));function addMarkersForModel(_x) {return _addMarkersForModel.apply(this, arguments);}return addMarkersForModel;}() }, { key: "setSelectedViewport", value: function setSelectedViewport(
    ...
    } }, { key: "showSheetAndSetTransform", value: function () {var _showSheetAndSetTransform = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(

      node, viewport, model3D) {var model, unitScale, viewportBounds, matrix, model3DMatrix, clearSelectedFloor;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                this.setSelectedViewport(viewport);_context4.next = 3;return (

                  this.loadModel(node));case 3:model = _context4.sent;
                ...
                this.showModel(node);return _context4.abrupt("return",

                model);case 17:case "end":return _context4.stop();}}}, _callee4, this);}));function showSheetAndSetTransform(_x2, _x3, _x4) {return _showSheetAndSetTransform.apply(this, arguments);}return showSheetAndSetTransform;}() }, { key: "hideSelectedSheet", value: function hideSelectedSheet()
    ...
    // If this model was changed due to a transition, reset those changes
      ...
      return true;
    } }, { key: "getViewportsForModelAsync", value: function () {var _getViewportsForModelAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(

      model) {var viewports;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (
                  this.viewportsExtension.getViewportsAsync(model.getDocumentNode(), { onlyTopViewPlans: false }));case 2:viewports = _context5.sent;
                ...
                viewports);case 5:case "end":return _context5.stop();}}}, _callee5, this);}));function getViewportsForModelAsync(_x5) {return _getViewportsForModelAsync.apply(this, arguments);}return getViewportsForModelAsync;}() }, { key: "getViewportsForModel", value: function getViewportsForModel(
    ...
    // Given a 2D sheet (and optionally a viewport guid), returns a bubbleNode of the 3D node that it's attached to.
  }, { key: "getNodeAndViewport", value: function () {var _getNodeAndViewport = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(model2D, vpGuid) {var viewports, viewport, nodes, bubbleNode3D;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:_context6.next = 2;return (
                  this.getViewportsForModelAsync(model2D));case 2:viewports = _context6.sent;

                viewport = vpGuid ?
                viewports.find(function (vp) {return vp.getGuid() === vpGuid;}) :
                viewports[viewports.length - 1];if (

                this.cache.nodesAndViewports.has(viewport)) {_context6.next = 11;break;}_context6.next = 7;return (
                  viewport.get3DNodesForViewport());case 7:nodes = _context6.sent;
                ...
                this.cache.nodesAndViewports.set(viewport, { viewport: viewport, bubbleNode: bubbleNode3D });case 11:return _context6.abrupt("return",


                this.cache.nodesAndViewports.get(viewport));case 12:case "end":return _context6.stop();}}}, _callee6, this);}));function getNodeAndViewport(_x6, _x7) {return _getNodeAndViewport.apply(this, arguments);}return getNodeAndViewport;}()
    ...
    } }, { key: "transitionModelToSheet", value: function () {var _transitionModelToSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(

      model) {return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
                this.duringModelToSheetTransition = true;
                this.destroyUIFor3D();_context7.next = 4;return (
                  this.modelToSheet.transition3Dto2D(model));case 4:
                this.duringModelToSheetTransition = false;case 5:case "end":return _context7.stop();}}}, _callee7, this);}));function transitionModelToSheet(_x8) {return _transitionModelToSheet.apply(this, arguments);}return transitionModelToSheet;}() }, { key: "onExtensionLoaded", value: function onExtensionLoaded(_ref3)
    ...
    {var _this$selectedViewpor;
      ...
      if ((_this$selectedViewpor = this.selectedViewport) === null || _this$selectedViewpor === void 0 ? void 0 : _this$selectedViewpor.isTopViewViewport()) {
    ...
    this.viewer = extension.viewer;
      ...
      model2D) {var nodeAndViewportPromise, bubbleNode, viewport, _yield$nodeAndViewpor, model3D, unitScale, matrix, modelToViewerTransform, viewportBounds;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
                ...
                viewportBounds) {_context.next = 38;break;}_context.next = 38;return (
                  Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_1__["setViewportBounds"])(this.viewer, model2D, viewportBounds, _ModelSheetConstants__WEBPACK_IMPORTED_MODULE_0__["HIDE_DURATION"]));case 38:case "end":return _context.stop();}}}, _callee, this, [[6, 14]]);}));function transition2Dto3D(_x) {return _transition2Dto3D.apply(this, arguments);}return transition2Dto3D;}() }]);return SheetToModel;}();
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var ModelSheet3DMarker = /*#__PURE__*/function () {
  function ModelSheet3DMarker(extension, viewport, model3D, ui, isVisible) {_classCallCheck(this, ModelSheet3DMarker);
    ...
    isSelected) {
      if (isSelected) {
        ...
        this.extension.onMarkerDeselected(this);
    ...
    } }, { key: "hideSheet", value: function () {var _hideSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var node;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (
                ...
                this.setMarkerSelected(false);case 7:case "end":return _context2.stop();}}}, _callee2, this);}));function hideSheet() {return _hideSheet.apply(this, arguments);}return hideSheet;}() }, { key: "showSheet", value: function () {var _showSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var node, model;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!
                ...
                this.setMarkerSelected(true);_context3.next = 5;return (
                  ...
                  this.extension.showSheetAndSetTransform(node, this.viewport, this.model3D));case 8:model = _context3.sent;if (
