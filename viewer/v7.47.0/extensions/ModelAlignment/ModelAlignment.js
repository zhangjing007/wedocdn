...
var ToolbarGroupsToKeep = [Autodesk.Viewing.TOOLBAR.NAVTOOLSID];var
...
SheetAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(SheetAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(SheetAlignmentExtension);
  ...
  function SheetAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, SheetAlignmentExtension);
    ...
    _this.getVersionUrn = _this.options.getVersionUrn;return _this;
                ...
                }case 27:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    // Aligment is allowed only if the model is on the latest version
                ...
                this.getVersionUrn) {_context3.next = 3;break;}
                ...
                lineage = bubbleNode.lineageUrn();_context3.prev = 5;_context3.next = 8;return (


                  this.getVersionUrn(lineage));case 8:latestUrn = _context3.sent;_context3.next = 14;break;case 11:_context3.prev = 11;_context3.t0 = _context3["catch"](5);

                console.error('getVersionUrn failed or canceled');case 14:return _context3.abrupt("return",


                currentUrn === latestUrn);case 15:case "end":return _context3.stop();}}}, _callee3, this, [[5, 11]]);}));function isAlignmentAllowed(_x2) {return _isAlignmentAllowed.apply(this, arguments);}return isAlignmentAllowed;}() }, { key: "setHasAlignPermission", value: function setHasAlignPermission(
    ...
    // Set 2D model to be aligned next
      ...
      urn, guid) {var model;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                ...
                this.cancel();return _context4.abrupt("return");case 6:



                this.showSheet();case 7:case "end":return _context4.stop();}}}, _callee4, this);}));function onSheetSelected(_x3, _x4) {return _onSheetSelected.apply(this, arguments);}return onSheetSelected;}() }, { key: "showSheet", value: function () {var _showSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {var _this$viewer$getExten,_this3 = this;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                ...
                // Hide section gizmos but keep sections.
                (_this$viewer$getExten = this.viewer.getExtension('Autodesk.Section')) === null || _this$viewer$getExten === void 0 ? void 0 : _this$viewer$getExten.deactivate(true);
                ...
                this.viewer.impl.changePaperVisibility(this.model, false, true, function () {
                  ...
                  _this3.show();
                }, 1);case 17:case "end":return _context5.stop();}}}, _callee5, this);}));function showSheet() {return _showSheet.apply(this, arguments);}return showSheet;}() }, { key: "setTarget3DModel", value: function setTarget3DModel(
...

    {
      ...
      if (this.model) {var _this$options$hideShe, _this$options;
        // Restore paper visibility.
        this.viewer.impl.changePaperVisibility(this.model, true);
        // Restore original transform.
        this.viewer.impl.setPlacementTransform(this.model, new THREE.Matrix4());

        (_this$options$hideShe = (_this$options = this.options).hideSheet) === null || _this$options$hideShe === void 0 ? void 0 : _this$options$hideShe.call(_this$options, this.model);
      }
    ...
    model, show) {var _this5 = this;
      ...
      var onTimer = function onTimer(t) {
        ...
        _this5.viewer.impl.invalidate(true);
      };
      ...
      return new Promise(function (resolve) {
        var onFinished = function onFinished() {
          ...
          delete _this5.animationHandleMap[model.id];

          resolve();
        };

        _this5.animationHandleMap[model.id] = Autodesk.Viewing.Private.fadeValue(0, 1, _this5.fadeDuration, onTimer, onFinished);
      });
    }
    ...
    menu, status) {var _intersection$model,_intersection$face,_this6 = this;
      ...
      var menuEntry = {
        ...
        target: function target() {
          _this6.surfacePreselected = true;
          _this6.onSurfacePicked({ point: point, normal: normal, modelId: model.id, dbId: intersection.dbId });
        } };
    ...
    /**
      ...
      */ }, { key: "saveChanges", value: function () {var _saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {var _model$getPlacementTr;var success, model, target3DModel, matrix, sheetNode, sheetUrn, sheetLineageUrn, sheetViewableName, target3DModelNode, target3DModelLineageUrn, cropRegion, regionId;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:if (!(
                ...
                // Hide sheet when done.
                this.cancel();

                // Save relationship of 2D region and 3D model.
                _context6.next = 23;return this.options.alignmentService.saveRelationship(
                target3DModelLineageUrn,
                target3DModelNode.name(),
                sheetLineageUrn,
                sheetViewableName,
                regionId);case 23:success = _context6.sent;_context6.t0 =



                success;if (!_context6.t0) {_context6.next = 29;break;}_context6.next = 28;return this.options.alignmentService.saveRegion(
                sheetUrn,
                sheetViewableName,
                regionId,
                cropRegion.bbox,
                matrix);case 28:_context6.t0 = _context6.sent;case 29:success = _context6.t0;
                ...
                success);case 32:case "end":return _context6.stop();}}}, _callee6, this);}));function saveChanges() {return _saveChanges.apply(this, arguments);}return saveChanges;}() }, { key: "clearHighlight", value: function clearHighlight()
    ...
    isSurfaceSelected) {var initialModel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.target3DModel;
      ...
      this.fireEvent({
        ...
        file: file,
        onSheetSelected: isSurfaceSelected ? this.onSheetSelected : this.prepareForPickingSurface });

    } }, { key: "onAlignmentStart", value: function onAlignmentStart()

    {
      var toolbar = this.viewer.getToolbar();
      var viewerToolbarContainer = toolbar === null || toolbar === void 0 ? void 0 : toolbar.container;

      if (viewerToolbarContainer) {
        for (var i = 0; i < viewerToolbarContainer.children.length; i++) {

          // Keep only the toolbar groups that are part of ToolbarGroupsToKeep.
          if (!ToolbarGroupsToKeep.includes(viewerToolbarContainer.children[i].id)) {
    ...
    } }, { key: "onAlignmentEnd", value: function onAlignmentEnd()

    {
      ...
      this.fireEvent({ type: Events.SHEET_ALIGNMENT_END });
    ...
    urn, guid) {
      // First of all, clear any other alignment in progress.
      this.cancel();
