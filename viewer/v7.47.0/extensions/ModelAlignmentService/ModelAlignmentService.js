    ...
    // Only used for testing. In practice, alignment 
      ...
      lineageUrn, versionUrn, viewablePartId, regionId) {var _this2 = this;var alignedItemID, relationships, item, regions;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:
                ...
                relationships.length) {_context11.next = 6;break;}throw (
                  ...
                  Promise.all(relationships.map(function (r) {return _this2.deleteRelationship(r.id);})));case 9:_context11.next = 14;break;case 11:_context11.prev = 11;_context11.t0 = _context11["catch"](6);throw _context11.t0;case 14:_context11.next = 16;return (





                  this.cache.getItem(alignedItemID));case 16:item = _context11.sent;
                regions = item === null || item === void 0 ? void 0 : item.regions;if (
                regions) {_context11.next = 21;break;}
                console.warn('No regions to delete');return _context11.abrupt("return");case 21:if (!(



                regions.length > 1)) {_context11.next = 27;break;}
                // Update the regions list. This will overwrite the item.
                item.regions = regions.filter(function (r) {return r.regionId !== regionId;});_context11.next = 25;return (
                  this.alignmentApi.saveItem(item));case 25:_context11.next = 28;break;case 27:

                // This is the only region in the item
                this.deleteItem(versionUrn, viewablePartId);case 28:case "end":return _context11.stop();}}}, _callee11, this, [[6, 11]]);}));function deleteRegion(_x24, _x25, _x26, _x27) {return _deleteRegion.apply(this, arguments);}return deleteRegion;}() }, { key: "getRelationships", value: function () {var _getRelationships = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(
