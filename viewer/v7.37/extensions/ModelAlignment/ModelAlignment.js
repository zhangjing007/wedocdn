  ...
  function ModelAlignmentBase(viewer, options) {var _this;_classCallCheck(this, ModelAlignmentBase);
    ...
    // Save & clear all pending changes. Requires an alignment service.
      ...
      for (var key in this.pendingChanges) {var _this$options$alignme;
        ...
        (_this$options$alignme = this.options.alignmentService) === null || _this$options$alignme === void 0 ? void 0 : _this$options$alignme.saveTransform(urn, viewablePartId, matrix);
      }
    ...
    //  @param {Model} model
    value: function () {var _isAlignmentLocked = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(model) {var cachedFlag, as, docNode, urn, viewableName;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                ...
                cachedFlag !== undefined)) {_context2.next = 3;break;}return _context2.abrupt("return",
                cachedFlag);case 3:


                // Make sure alignment service is available.
                as = this.options.alignmentService;if (
                as) {_context2.next = 7;break;}
                console.error('Alignment service must be set to check lock flag.');return _context2.abrupt("return",
                false);case 7:
                ...
                viewableName = model.is2d() ? docNode.name() : undefined;_context2.next = 12;return (
                  as.isAlignmentLocked(urn, viewableName));case 12:return _context2.abrupt("return", _context2.sent);case 13:case "end":return _context2.stop();}}}, _callee2, this);}));function isAlignmentLocked(_x) {return _isAlignmentLocked.apply(this, arguments);}return isAlignmentLocked;}()
...
SheetAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(SheetAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(SheetAlignmentExtension);
  ...
  function SheetAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, SheetAlignmentExtension);
    ...
    _this.modelTransformToolAxis = ['X', 'Y', 'XY'];return _this;
                ...
                this.boundsPlane = new _ModelSheetTransition_BoundsPlane__WEBPACK_IMPORTED_MODULE_3__["default"](this.viewer, OverlayName);case 22:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    /**
      ...
      */ }, { key: "saveChanges", value: function () {var _saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var matrix, sheetNode, sheetUrn, sheetLineageUrn, sheetViewableName, target3DModelNode, target3DModelLineageUrn, cropRegion;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (!(



                !this.model || !this.target3DModel)) {_context4.next = 2;break;}return _context4.abrupt("return");case 2:
                ...
                _context4.next = 16;return this.options.alignmentService.saveRelationship(
                target3DModelLineageUrn,
                encodeURIComponent(target3DModelNode.name()),
                sheetLineageUrn,
                encodeURIComponent(sheetViewableName),
                this.model.regionId);case 16:_context4.next = 18;return (



                  this.options.alignmentService.saveViewport(
                  sheetUrn,
                  sheetViewableName,
                  this.model.regionId,
                  cropRegion.bbox,
                ...
                this.cancel();case 21:case "end":return _context4.stop();}}}, _callee4, this);}));function saveChanges() {return _saveChanges.apply(this, arguments);}return saveChanges;}() }, { key: "clearHighlight", value: function clearHighlight()
    ...
    {
      var rootNode = this.target3DModel.getDocumentNode().getRootNode();
      ...
      this.fireEvent({ type: Events.SELECT_SHEET, file: file, onSheetSelected: this.onSheetSelected });
    ...
    urn, guid) {
      ...
      // Pre-fetch the sheet in the meantime if bubbleNode is supplied.
      if (urn && guid) {
