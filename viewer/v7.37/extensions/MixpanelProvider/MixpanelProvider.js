  ...
  function Mixpanel(options) {var _this;_classCallCheck(this, Mixpanel);
    ...
    distinctId) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.identify(distinctId);
        ...
        config: { persistence: 'localStorage', batch_requests: true, batch_size: 500, batch_flush_interval_ms: 15000 } };} }]);return Mixpanel;}(Autodesk.Viewing.Private.AnalyticsProviderInterface);
