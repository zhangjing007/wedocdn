  ...
  function ModelSheetTransitionExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, ModelSheetTransitionExtension);
    ...
    {var _this2 = this;
      ...
      this.toolbarButton.onClick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var model;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!
                ...
                model) {_context2.next = 7;break;}
                console.warn('No suitable 2D model found for sheet to model transition');return _context2.abrupt("return");case 7:


                _this2.setButtonEnabled(false, true);_context2.next = 10;return (
    ...
    {var _this3 = this;
      ...
      model) {var _this4 = this;var relatedViewports, vpKeys, keysToRemove;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!(
                !model.is3d() || !model.getDocumentNode())) {_context3.next = 2;break;}return _context3.abrupt("return");case 2:
                ...
                });case 11:case "end":return _context3.stop();}}}, _callee3, this);}));function addMarkersForModel(_x) {return _addMarkersForModel.apply(this, arguments);}return addMarkersForModel;}() }, { key: "getSelectedViewportGuid", value: function getSelectedViewportGuid()
