...
/**
                 ...
                 *
                 * @param {string} id A unique identifier used to identify this instance of
                 * ViewableStyle. This identifier is not used internally by the extension.
                 * @param {number} type The type of viewable. Possible values are listed in
                 * ViewableType.
                 ...
                 */
function ViewableStyle(id) {var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ViewableType.SPRITE;var color = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { r: 255, g: 255, b: 255 };var url = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "";_classCallCheck(this, ViewableStyle);
  this.id = id;
  this.type = type;
  this.color = color;
  this.url = url;
...
CustomViewable = /*#__PURE__*/function () {
  /**
                                            * @constructor
                                            * Constructs an instance of CustomViewable object
                                            *
  ...
  /**
     * @returns {ViewableStyle} The style definition of this custom viewable object.
    ...
    /**
       * @returns {THREE.Vector3} The position of the viewable in world coordinates.
    ...
    /**
       * @returns {number} The DbId of this custom viewable object. This value is used
       * to identify the viewable when user input events such as mouse clicks are handled.
...
SpriteViewable = /*#__PURE__*/function (_CustomViewable) {_inherits(SpriteViewable, _CustomViewable);var _super = _createSuper(SpriteViewable);
  ...
  /**
     * @returns {number} The type of this SpriteViewable.
    ...
    /**
       * @returns {THREE.Color} The color of this sprite viewable object. The
       * color is multiplied with the sprite pixel colors in shader for display.
...
/**
                                                    ...
                                                    * object is added for display through DataVisualization.addViewables API. When
                                                    * that happens, all CustomViewable objects within ViewableData will then be
                                                    * displayed.
                                                    */var
ViewableData = /*#__PURE__*/function () {
  ...
  /**
     * @returns {CustomViewable[]} All the CustomViewable that are managed by
    ...
    /**
                                                          ...
                                                          *
                                                          * @param {CustomViewable} viewable The custom viewable to be added to the
                                                          * ViewableData object.
    ...
    /**
       ...
       */ }, { key: "finish", value: function () {var _finish = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  ...
                  this._spriteAtlas.finish());case 2:case "end":return _context.stop();}}}, _callee, this);}));function finish() {return _finish.apply(this, arguments);}return finish;}() }, { key: "viewables", get: function get() {return this._viewables;} /**
...
Room = /*#__PURE__*/function () {
  ...
  /**
     * @param {{properties: any[]}} value The extended room information
    ...
    /**
                                                * Adds a client-defined device to the room
                                                *
    ...
    device) {
      this._devices.push(device);
                                                                        ...
                                                                        */, /**
                                                                             * @returns {{properties: any[]}} The extended room information
                                                                             */get: function get() {return this._info;} }, { key: "id", get: function get() {return this._id;} /**
                                                                                                                                                                                ...
                                                                                                                                                                                */ }, { key: "name", get: function get() {return this._name;} /**
                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                               */ }, { key: "bounds", get: function get() {return this._bounds;} /**
                                                                                                                                                                                                                                                                                                                  * @returns {Device[]} The list of all devices in the room
                                                                                                                                                                                                                                                                                                                  */ }, { key: "devices", get: function get() {return this._devices;} }]);return Room;}();var LevelRoomsMap = /*#__PURE__*/function () {function LevelRoomsMap() {_classCallCheck(this, LevelRoomsMap);}_createClass(LevelRoomsMap, [{ key: "addRoomToLevel", /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * Adds a room to a named level.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * @param {string} levelName Name of the level to add the room to
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * @param {Room} room The room to be added to the level
    ...
    /**
       ...
       * are to be retrieved.
       * @param {boolean} onlyRoomsWithDevices Set this to true to return only
       * rooms with devices in them, or false to return all rooms on the level.
       * @returns {Room[]} List of all the rooms found on the level,
       * or an empty list if no room is found.
       */ }, { key: "getRoomsOnLevel", value: function getRoomsOnLevel(
    levelName, onlyRoomsWithDevices) {
      /** @type {Room[]} */
      var rooms = this[levelName] || [];
...
ModelStructureInfo = /*#__PURE__*/function () {
  ...
  /**
     ...
     *
     * @returns {Array.<number>} A list of all child node DbIds that match
     * the filter name.
    ...
    /**
       ...
       *
       * @param {boolean} [keepRoomDetail=false] Whether to keep the room detailed
       * properties after this call completes.
    ...
    room) {
      if (room && room.info && room.info.properties) {
        var prop = room.info.properties.find(function (p) {
          return p.type == 20 && p.displayName == "Level" && p.attributeName == "Level";
        });
    ...
    /**
                                                                                                                                                                                               * Assigns cient-defined devices to rooms based on their 3D space positions
    ...
    /**
                                                                                                                                                                                                                                          * TODO: Add geometry contains for more detailed check
                                                                                                                                                                                                                                          * For now only do the simplest check
                                                                                                                                                                                                                                          *
                                                                                                                                                                                                                                          * Checks if a given point is within the bounds of a room.
                                                                                                                                                                                                                                          *
                                                                                                                                                                                                                                          * @param {Room} room The room against which a point is checked.
                                                                                                                                                                                                                                          * @param {{x: number, y: number, z: number}} point The point to be
                                                                                                                                                                                                                                          * checked.
        ...
        fragments.map(function (fragment) {
          ...
          if (geometry.attributes["id"] && geometry.attributes["flagp"]) {
            ...
            for (var i = 0; i < ids.length; i += 3) {
              ...
              flags[i / 3] = dbIdIndex.has(id) ? 1 : 0;
            }
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * A SurfaceShadingPoint object can be used to represent real-world quantifiable
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * properties that require grouping. A SurfaceShadingPoint object contains one or
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * more properties, each of which has its own value.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * For an example, consider an IoT scenario of a physical sensor device that
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * exposes multiple sensor properties such as "temperature" and "humidity", each
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * of which has its own numeric values. In this scenario, a SurfaceShadingPoint
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * can be used to represent the physical sensor device, where properties such as
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * "temperature" and "humidity" are the "(sensor) types" defined in the said
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * SurfaceShadingPoint object.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           */var
SurfaceShadingPoint = /*#__PURE__*/function () {"use strict";
  /**
                                                               ...
                                                               * @param {{x:number, y: number, z: number}} position The position of this
                                                               * SurfaceShadingPoint object in the world space.
  ...
  /**
     * A helper function to position the shading point based on the center
     * point that is derived from geometry bounding boxes of the given DbId.
     * 
     * @param {Model} model The model that contains the given DbId.
     * @param {number} dbId The DbId of the object to derive the center
     * point from.
     * 
     * @alias Autodesk.DataVisualization.SurfaceShadingPoint#positionFromDBId
...
SurfaceShadingNode = /*#__PURE__*/function () {"use strict";
  /**
                                                              ...
                                                              * basic rendering unit. A basic rendering unit can contain one or more
                                                              * dbId, each representing a geometry.
                                                              *
                                                              ...
                                                              * which represents a geometry that makes up the SurfaceShadingNode.
                                                              * @param {SurfaceShadingPoint[]} shadingPoints An optional array of
                                                              * SurfaceShadingPoint objects.
                                                              */
  ...
  /**
     ...
     * 
     * @alias Autodesk.DataVisualization.SurfaceShadingNode#addPoint
     */_createClass(SurfaceShadingNode, [{ key: "addPoint", value: function addPoint(
    point) {
      if (!this.shadingPoints) {
        this.shadingPoints = [];
      }
    ...
    /**
       ...
       * 
       * @alias Autodesk.DataVisualization.SurfaceShadingNode#update
...
/**
                                          * A grouping data structure that allows rendering units to be organized in
                                          * a hierarchical manner. It can contain zero or more sub-groups and/or 
                                          * SurfaceShadingNode leaf nodes as child.
                                          */var
SurfaceShadingGroup = /*#__PURE__*/function () {"use strict";
  ...
  /**
    ...
    /**
                                                              ...
                                                              * @param {SurfaceShadingGroup|SurfaceShadingNode} child The child node
                                                              * to be added to the shading group. A child node can either be another
                                                              * shading group, or a leaf shading node.
                                                              * @alias Autodesk.DataVisualization.SurfaceShadingGroup#addChild
    ...
    /**
       ...
       * @param {Model} model The model from which fragment IDs are to be obtained.
       * @alias Autodesk.DataVisualization.SurfaceShadingGroup#update
       */ }, { key: "update", value: function update(
    model) {
    ...
    /**
       ...
       * 
       * @alias Autodesk.DataVisualization.SurfaceShadingGroup#getLeafsById
    ...
    /**
       ...
       * 
       * @alias Autodesk.DataVisualization.SurfaceShadingGroup#getChildLeafs
...
/**
                                                                                                              * An abstraction concept of SurfaceShadingGroup.
                                                                                                              */var
...
/**
                       ...
                       * device identifier and sensor type.
                       *
                       * @param {Device} device The client defined device passed in through
  ...
  function DataVisualization(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, DataVisualization);
    ...
    if (options["useInternal"] !== true) {
      ...
      console.warn(terms);
                ...
                true);case 16:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    /**
       * Adds a collection of viewable objects for display through the ViewableData
       * that manages them.
       *
       * @alias Autodesk.Viewing.Extensions.DataVisualization#addViewables
       * @param {CustomViewables.ViewableData} data The ViewableData that contains
       * all the CustomViewable objects which are to be added for display.
    ...
    data) {var _this2 = this;
      ...
      data.viewables.map(function (item) {
        if (item.position) {
    ...
    /**
       * Removes all viewables from display. This function is useful in scenarios
       * when a subset of viewables are to be hidden (i.e. removed from display),
       * as it is easier to regenerate viewables than to selectively modify the
       * underlying data.
       *
    ...
    /**
       * Enables or disables depth testing for custom viewable objects. When depth
       * testing is enabled for custom viewables, they will be occluded by objects
       * in the scene that are nearer to the camera. If depth testing is disabled
       * for custom viewables, they will always be visible regardless of other objects
       * that may be blocking them.
       *
       ...
       * this parameter to true to enable depth testing for custom viewables, or false
       * otherwise.
    ...
    /**
       * Sets the visibility of custom viewables, while enabling or disabling the
       * occlusion for these custom viewables.
       *
       ...
       * camera. Set this to false in order to always display custom viewables on top
       * of the view and not be occluded by other objects in the scene.
    ...
    /**
       ...
       * @param {Model} model The model to set up the shading for. It is used
       * to establish connections between DbId and the corresponding fragments so
       * that heatmap can be rendered.
       * @param {SurfaceShadingInfo.SurfaceShadingData} shadingData The surface
       * shading data to set up the shading with.
    ...
    /**
       ...
       * necessary resources like overlay scene and materials, therefore is by
       * design to be called only when necessary (i.e., when surface shading needs
       * to be updated due to geometry changes). For more lightweight rendering,
       * updateSurfaceShading API should be used instead.
       *
       ...
       * to render. These identifiers are among the ones provided through
       * SurfaceShadingData in a prior call to setupSurfaceShading API.
       * @param {string} sensorType The type of sensor to render the shading for.
    ...
    /**
       ...
       * This API simply updates the resources created in a prior call to the
       * renderSurfaceShading without recreating them, therefore it is a more
       * lightweight alternatives suited for rapid calls.
