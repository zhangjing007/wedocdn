  ...
  /**
    ...
    */_createClass(PixelCompare, [{ key: "getModel", value: function getModel(
...

    {
      ...
      var mainBounds = this.mainModel.getVisibleBounds(false, true);
      var secondaryBounds = this.secondaryModel.getVisibleBounds(false, true);
      ...
      var scaleMatrix = new THREE.Matrix4().makeScale(this.modelsRatio.x, this.modelsRatio.y, 1);
      var translationToModelOrigin = new THREE.Matrix4().makeTranslation(mainBounds.min.x, mainBounds.min.y, 0);

      this.viewer.impl.setPlacementTransform(this.secondaryModel, translationToModelOrigin.multiply(scaleMatrix.multiply(translationToOrigin)));
    }
    ...
    model) {
      var bounds = model.getVisibleBounds(false, true);
    ...
    translation) {
      var translationMatrix = new THREE.Matrix4().makeTranslation(translation.x / this.modelsRatio.x, translation.y / this.modelsRatio.y, 0);
      var currentMatrix = this.secondaryModel.getPlacementTransform().clone();
      this.viewer.impl.setPlacementTransform(this.secondaryModel, currentMatrix.multiply(translationMatrix));
    }
