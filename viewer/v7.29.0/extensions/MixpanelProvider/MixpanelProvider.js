...
var namespace = AutodeskNamespace('Autodesk.Viewing');
namespace["MixpanelProvider"] = new _mixpanel__WEBPACK_IMPORTED_MODULE_0__["Mixpanel"](_mixpanel__WEBPACK_IMPORTED_MODULE_0__["options"]);var
...
Autodesk.Viewing.theExtensionManager.registerExtension('Autodesk.Viewing.MixpanelExtension', MixpanelExtension);
...
/*!*************************************************!*\
  !*** ./extensions/MixpanelProvider/mixpanel.js ***!
  \*************************************************/
/*! exports provided: Mixpanel, options */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
Mixpanel = /*#__PURE__*/function (_Autodesk$Viewing$Pri) {_inherits(Mixpanel, _Autodesk$Viewing$Pri);var _super = _createSuper(Mixpanel);
  function Mixpanel(options) {_classCallCheck(this, Mixpanel);return _super.call(this,
    options);
...

    {
      ...
      return mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.init(this.options.token, this.options.config);
    }
    ...
    } }, { key: "name", get: function get() {return PROVIDER_NAME;} }]);return Mixpanel;}(Autodesk.Viewing.Private.AnalyticsProviderInterface);


var MIXPANEL_TOKEN = null;
switch ("Production") {
  case 'Production':
  case 'Development':
  case 'Staging':
  case 'fluent':
    ...
    break;
  default:
  // Mixpanel is turned off for Fluent / PR / Local builds
}
