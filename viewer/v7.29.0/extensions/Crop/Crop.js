...
CropExtension = /*#__PURE__*/function (_av$Extension) {_inherits(CropExtension, _av$Extension);var _super = _createSuper(CropExtension);
  function CropExtension(viewer, options) {var _this;_classCallCheck(this, CropExtension);
    ...
    Autodesk.Viewing.EventDispatcher.prototype.apply(_assertThisInitialized(_this));return _this;
  }_createClass(CropExtension, [{ key: "load", value: function () {var _load = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var DefaultCropStyle, models2D, defaultModel;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                ...
                models2D = this.viewer.impl.get2DModels();
                defaultModel = models2D.length > 0 ? models2D[0] : null;

                // Model that's gonna be cropped.
                ...
                true);case 13:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    // Calculate & update viewport bounds for all target models, according to current crop.
      ...
      this.setViewportBoundsForModel(this.targetModel, bbox);

      this.viewer.impl.invalidate(true, true, false);
    }

    // Update viewportBounds for a single model.
  }, { key: "setViewportBoundsForModel", value: function setViewportBoundsForModel(model, bbox) {
      if (model.isLeaflet()) {
        ...
        Object.values(modelMaterials.mats).forEach(function (m) {
          matman.setMaterialViewportBounds(m, bbox);
        });

        Object.values(modelMaterials.selectionMats).forEach(function (m) {
          matman.setMaterialViewportBounds(m, bbox);
        });
      }
    ...
    {
      this.getEdit2DContext().clearLayer(false);
    }
    ...
    // Clear the effect of the cropping - removes viewportBounds from all the target models.
      ...
      if (this.targetModel) {
        this.setViewportBoundsForModel(this.targetModel, null);
        this.viewer.impl.invalidate(true, true, false);
      }
    }
...
var CropRegion = /*#__PURE__*/function () {
  ...
  _createClass(CropRegion, [{ key: "getCropInUnits", value: function getCropInUnits(targetUnits) {
      ...
      // Make sure that the unit strings are in the correct format.
      var fromUnits = Autodesk.Viewing.Model.prototype.getUnitData(this.units).unitString;
      var toUnits = Autodesk.Viewing.Model.prototype.getUnitData(targetUnits).unitString;

      var factor = Autodesk.Viewing.Private.convertUnits(fromUnits, toUnits, 1, 1);
