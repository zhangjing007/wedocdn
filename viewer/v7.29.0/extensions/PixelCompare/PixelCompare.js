  ...
  /**
    ...
    */_createClass(PixelCompare, [{ key: "getModel", value: function getModel(
      ...
      */ }, { key: "initVirtualCamera", value: function initVirtualCamera()
    {
      ...
      if (this.mainModel.isLeaflet() && this.secondaryModel.isLeaflet()) {
        offset.y = -offset.y;
      } else if (this.mainModel.isLeaflet() && !this.secondaryModel.isLeaflet()) {
...
PixelCompareTool = /*#__PURE__*/function () {
  function PixelCompareTool(extension) {_classCallCheck(this, PixelCompareTool);
    ...
    event, keyCode) {
      ...
      if (translation) {
        var mainCamera = this.viewer.getCamera();
        var p1 = this.viewer.clientToWorld(translation.x, translation.y, undefined, true).point;
        var p2 = this.viewer.clientToWorld(0, 0, undefined, true).point;
