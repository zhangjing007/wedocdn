...
var SectionTool = function SectionTool(viewer, options)
{
  ...
  this.handleSingleClick = function (event /*, button*/) {
    ...
    if (result) {var _sectionGroups$;
      ...
      if (((_sectionGroups$ = _sectionGroups[0]) === null || _sectionGroups$ === void 0 ? void 0 : _sectionGroups$.children.length) > 1 && prevObject !== result.object) {
  ...
  /**
      ...
      */
  this.setSectionPlane = function (normal, position) {var _transRotControl2;var enableRotationGizmo = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
