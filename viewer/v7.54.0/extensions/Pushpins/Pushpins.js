...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css":
/*!*******************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css ***!
  \*******************************************************************************************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "statusHexValues": () => (/* binding */ statusHexValues),
/* harmony export */   "moveableIcon": () => (/* binding */ moveableIcon),
/* harmony export */   "cursorIcon": () => (/* binding */ cursorIcon),
/* harmony export */   "markerOffsets": () => (/* binding */ markerOffsets),
/* harmony export */   "thumbnailOriginalPixelSize": () => (/* binding */ thumbnailOriginalPixelSize),
/* harmony export */   "thumbnailSize": () => (/* binding */ thumbnailSize),
/* harmony export */   "thumbnailZoom": () => (/* binding */ thumbnailZoom),
/* harmony export */   "thumbnailMarkerRadius": () => (/* binding */ thumbnailMarkerRadius),
/* harmony export */   "ATTRIBUTES_VERSION": () => (/* binding */ ATTRIBUTES_VERSION)
/* harmony export */ });
var statusHexValues = {
  /* Issues */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PUSHPIN_EVENTS": () => (/* binding */ PUSHPIN_EVENTS)
/* harmony export */ });
var PUSHPIN_EVENTS = {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinInputHandler)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "findMatchingModel": () => (/* binding */ findMatchingModel),
/* harmony export */   "default": () => (/* binding */ PushPinItem)
/* harmony export */ });
...
PushPinItem = /*#__PURE__*/function () {
  function PushPinItem() {_classCallCheck(this, PushPinItem);
    ...
    // Note that the model of the Pushpin must be visible/loaded.
      ...
      if (placementTf) {
        (0,_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_0__.transformViewerState)(this.itemData.viewerState, placementTf);
      }
    }
    ...
    // The model that the issue is assigned to must be visible.
      ...
      if (modelLocalToViewer) {
        var viewerToModelLocal = modelLocalToViewer.clone().invert();
      ...
      if (modelLocalToWorld) {
        ...
        var worldToModelLocal = modelLocalToWorld.clone().invert();
        (0,_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_0__.transformViewerState)(localData.viewerState, worldToModelLocal);
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HTMLPushPinLabel)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinBillboardLabel)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "legacyToLocalPushPinData": () => (/* binding */ legacyToLocalPushPinData),
/* harmony export */   "getLegacyPushPinData": () => (/* binding */ getLegacyPushPinData),
/* harmony export */   "applyLegacyFallback": () => (/* binding */ applyLegacyFallback)
/* harmony export */ });
/* harmony import */ var _PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PushPins3D/PushPinViewerState */ "./extensions/Pushpins/PushPins3D/PushPinViewerState.js");
...
var fixOldDCPushPin = function fixOldDCPushPin(model, data) {
  ...
  var modelLocalToWorld = model.myData.placementTransform;
  var worldToModelLocal = modelLocalToWorld && modelLocalToWorld.clone().invert();
  ...
  if (modelLocalToWorld && data.viewerState) {
    ...
    (0,_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_0__.transformViewerState)(data.viewerState, worldToModelLocal);
  }
};
...
var applyLegacyFallback = function applyLegacyFallback(data, viewer) {
  ...
  var model = (0,_PushPinItem__WEBPACK_IMPORTED_MODULE_1__.findMatchingModel)(viewer, data.viewerState.seedUrn);
  if (!model) {
    return;
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinManager)
/* harmony export */ });
  ...
  function PushPinManager(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinManager);
    ...
    item) {var _this4 = this;
      ...
      return new Promise(function (resolve, reject) {var _item$data$position =
        ...
        if (_this4.viewer.model.isPdf(true)) {
          (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.convertPdfToLeaflet)(_this4.viewer, item.data);
        }
        ...
        if (_this4.viewer.model.isLeaflet()) {
          pWorld = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.applyPdfWorldScaling)(_this4.viewer, item.data);
        } else {
        ...
        if (_this4.viewer.model.is2d()) {
          ...
          if (!_this4.viewer.model.isPageCoordinates()) {
            thumbnailSizeWorld = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.clientToWorldLeaflet)(_this4.viewer, _PushPinConstants__WEBPACK_IMPORTED_MODULE_3__.thumbnailOriginalPixelSize, 0);
            zeroWorld = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.clientToWorldLeaflet)(_this4.viewer, 0, 0);
          } else {
    ...
    // Update locationIds array inside the item's data.
      ...
      if (this.viewer.model.isLeaflet()) {
        var pWorld = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.applyPdfWorldScaling)(this.viewer, item.data);
      ...
      if (isTriggeringEvent) {
        ...
        then(function (thumbnail) {var _newItem$data$positio =
          ...
          if (_this5.viewer.model.isPdf(true)) {
            (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.convertPdfToLeaflet)(_this5.viewer, newItem.data);
          }
    ...
    dataArray, createFromLocal, viewer) {var _this6 = this;
      dataArray.forEach(function (pushPinData) {
        if (_this6.viewer.model.isPdf(true)) {var _applyPdfWorldScaling =
          (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.applyPdfWorldScaling)(_this6.viewer, pushPinData),x = _applyPdfWorldScaling.x,y = _applyPdfWorldScaling.y,z = _applyPdfWorldScaling.z;
    ...
    id, data) {
      ...
      if (this.viewer.model.isPdf(true)) {var _applyPdfWorldScaling2 =
        (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.applyPdfWorldScaling)(this.viewer, data),x = _applyPdfWorldScaling2.x,y = _applyPdfWorldScaling2.y,z = _applyPdfWorldScaling2.z;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinMobileObserver)
/* harmony export */ });
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var av = Autodesk.Viewing;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinTool)
/* harmony export */ });
  ...
  function PushPinTool(viewer, pushPinManager) {_classCallCheck(this, PushPinTool);
    ...
    event) {
      ...
      if (result && this.pushPinInitData) {var _result$model;
        ...
        (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_1__.invertModelTransform)(this.pushPinInitData.position, result.model);
    ...
    event) {
      ...
      var clientX = event.canvasX;
      var clientY = event.canvasY;
      var result = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_1__.clientToWorld)(this.viewer, clientX, clientY);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ IssuePushPinVisButton)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinVisButton)
/* harmony export */ });
/* harmony import */ var _PushPinEvents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PushPinEvents */ "./extensions/Pushpins/PushPinEvents.js");
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ QualityIssuePushPinVisButton)
/* harmony export */ });
/* harmony import */ var _PushPinUi_PushPinVisButtonBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PushPinUi/PushPinVisButtonBase */ "./extensions/Pushpins/PushPinUi/PushPinVisButtonBase.js");
function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = _getPrototypeOf(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}var
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RfiPushPinVisButton)
/* harmony export */ });
/* harmony import */ var _PushPinUi_PushPinVisButtonBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PushPinUi/PushPinVisButtonBase */ "./extensions/Pushpins/PushPinUi/PushPinVisButtonBase.js");
function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = _getPrototypeOf(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}var
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clientToWorldLeaflet": () => (/* binding */ clientToWorldLeaflet),
/* harmony export */   "clientToWorld": () => (/* binding */ clientToWorld),
/* harmony export */   "applyPdfWorldScaling": () => (/* binding */ applyPdfWorldScaling),
/* harmony export */   "worldToClient": () => (/* binding */ worldToClient),
/* harmony export */   "convertPdfToLeaflet": () => (/* binding */ convertPdfToLeaflet),
/* harmony export */   "applyModelTransform": () => (/* binding */ applyModelTransform),
/* harmony export */   "invertModelTransform": () => (/* binding */ invertModelTransform)
/* harmony export */ });
...
function clientToWorldLeaflet(viewer, x, y) {
  ...
  var newX = worldPos.x * texWidth / boundsSize.x;
  var newY = worldPos.y * texHeight / boundsSize.y;
...
function worldToClient(viewer, point, originalDocumentResolution) {
  ...
  var boundsSize = bounds.getSize(new THREE.Vector3());
  var wx = x / (texWidth / dpiCorrection) * boundsSize.x;
  var wy = y / (texHeight / dpiCorrection) * boundsSize.y;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinBillboardTool2D)
/* harmony export */ });
...
PushPinBillboardTool2D = /*#__PURE__*/function () {
  function PushPinBillboardTool2D(viewer) {_classCallCheck(this, PushPinBillboardTool2D);
    ...
    item) {
      var worldPos = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_1__.applyPdfWorldScaling)(this.viewer, item.data);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RenderHandler2D)
/* harmony export */ });
    ...
    e) {var _this4 = this;
      if (this.selectedItem.marker) {
        if (this.selectedItem.marker.dragging) {
          ...
          var result = (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.clientToWorld)(this.viewer, this.newX, this.newY);
          ...
          this.pushPinManager.generateThumbnail(this.selectedItem).then(function (thumbnail) {var _this4$selectedItem$d =
            ...
            if (_this4.viewer.model.isPdf(true)) {
              (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__.convertPdfToLeaflet)(_this4.viewer, _this4.selectedItem.data);
            }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinBillboardTool3D)
/* harmony export */ });
/* harmony import */ var _PushPinLabel_PushPinBillboardLabel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PushPinLabel/PushPinBillboardLabel */ "./extensions/Pushpins/PushPinLabel/PushPinBillboardLabel.js");
/* harmony import */ var _PushPinConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../PushPinConstants */ "./extensions/Pushpins/PushPinConstants.js");
...
PushPinBillboardTool3D = /*#__PURE__*/function () {
  function PushPinBillboardTool3D(viewer) {var _this = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinBillboardTool3D);
    ...
    pushpin) {
      ...
      (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_3__.applyModelTransform)(p, model);
    ...
    item) {
      ...
      item.setViewerState((0,_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_2__.generateMetadata)(this.viewer, item));
...
/* harmony export */   "restoreViewState": () => (/* binding */ restoreViewState),
/* harmony export */   "transformViewerState": () => (/* binding */ transformViewerState)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RenderHandler3D)
/* harmony export */ });
  ...
  function RenderHandler3D(viewerApi, pushPinManager) {var _this = this;_classCallCheck(this, RenderHandler3D);
    ...
    event) {
      if (event.value) {
        ...
        this.pushpinBillboardTool.selectPushpin(this.selectedItem);
        (0,_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_3__.restoreViewState)(this.viewer, this.selectedItem, this.pushPinManager.restoreViewerStateImmediate);
    ...
    e) {var _this4 = this;
      if (this.selectedItem.marker.dragging) {
        ...
        if (result) {
          ...
          (0,_PushPinUtils__WEBPACK_IMPORTED_MODULE_5__.invertModelTransform)(this.selectedItem.data.position, result.model);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./PushPinExtension.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PushPinExtension)
/* harmony export */ });
/* harmony import */ var _PushPinEvents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PushPinEvents */ "./extensions/Pushpins/PushPinEvents.js");
...
PushPinExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(PushPinExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(PushPinExtension);
  function PushPinExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinExtension);
    ...
    // Convert legacy 3D pushPinData in-place to make sure that positions and viewerState are consistently in model-local coords.
      ...
      (0,_PushPinLegacyFallback__WEBPACK_IMPORTED_MODULE_7__.legacyToLocalPushPinData)(pushPinData, this.viewer);
      ...
      if (this.options.useLegacyFallback) {
        (0,_PushPinLegacyFallback__WEBPACK_IMPORTED_MODULE_7__.applyLegacyFallback)(pushPinData, this.viewer);
      }
    }
    ...
    // must match with viewer coordinates when using a single model with default loadOptions (default globalOffset and no transforms).
      ...
      return (0,_PushPinLegacyFallback__WEBPACK_IMPORTED_MODULE_7__.getLegacyPushPinData)(pushPin, this.viewer);
    }
...
Autodesk.Extensions.Pushpins = __webpack_exports__;
/******/ })()
;
