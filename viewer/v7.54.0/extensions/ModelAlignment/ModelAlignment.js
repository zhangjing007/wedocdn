...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignment.css":
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignment.css ***!
  \***********************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignmentPanel.css":
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignmentPanel.css ***!
  \****************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AngleToAngle)
/* harmony export */ });
  ...
  function AngleToAngle(viewer, coordPicker, screenOverlay) {var _this = this;_classCallCheck(this, AngleToAngle);
    ...
    // Rotates the given model, so that "from" angle is rotated to "to" angle
      ...
      return new Promise(function (resolve) {
        ...
        // Computes the interpolated placement transform after rotating by the given angle
        var computeRotatedPlacementTransform = function computeRotatedPlacementTransform(angle, dstMatrix) {
          // Note: this.center is in viewer coords, i.e. with subtracted globalOffset.
          // If we modify the placementMatrix, we must use the center in world-coords, i.e. without subtracted globalOffset
          return _this3.createRotation(angle, dstMatrix, centerWorld).multiply(startMatrix);
        };

        // Compute placement that the model will have after rotation is finished.
        _this3.animEndMatrix = computeRotatedPlacementTransform(offsetAngle, matrix).clone();
        ...
        var onTimer = function onTimer(unitTime) {
          ...
          // Note: this.center is in viewer coords, i.e. with subtracted globalOffset.
          // If we modify the placementMatrix, we must use the center in world-coords, i.e. without subtracted globalOffset
          computeRotatedPlacementTransform(angle, matrix);
        ...
        var onEnd = function onEnd() {
          ...
          _this3.fireEvent({ type: Events.ANIMATION_ENDED });
        };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FirstFromIndex": () => (/* binding */ FirstFromIndex),
/* harmony export */   "SecondFromIndex": () => (/* binding */ SecondFromIndex),
/* harmony export */   "FirstToIndex": () => (/* binding */ FirstToIndex),
/* harmony export */   "SecondToIndex": () => (/* binding */ SecondToIndex),
/* harmony export */   "default": () => (/* binding */ FourPointsAlignment)
/* harmony export */ });
...
var FourPointsAlignment = /*#__PURE__*/function (_Autodesk$Edit3D$NPoi) {_inherits(FourPointsAlignment, _Autodesk$Edit3D$NPoi);var _super = _createSuper(FourPointsAlignment);
  ...
  function FourPointsAlignment(viewer, coordPicker, screenOverlay) {var _this;_classCallCheck(this, FourPointsAlignment);
    ...
    model, offset) {var _this2 = this;
      ...
      this.anim = (0,_TransformCommon__WEBPACK_IMPORTED_MODULE_0__.animateEdgeToEdge)(s0, s1, t0, t1,
      {
    ...
    restoreSelection) {var _this3 = this;
      ...
      this.anim = (0,_TransformCommon__WEBPACK_IMPORTED_MODULE_0__.animateMatrixToMatrix)(model.getPlacementTransform().clone(), transform,
      {
        onChange: function onChange(matrix) {
          _this3.viewer.impl.setPlacementTransform(model, matrix);
        },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModelAlignmentExtension)
/* harmony export */ });
/* harmony import */ var _ModelAlignmentBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ModelAlignmentBase */ "./extensions/ModelAlignment/ModelAlignmentBase.js");
/* harmony import */ var _ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ModelAlignmentPanel */ "./extensions/ModelAlignment/ModelAlignmentPanel.js");
/* harmony import */ var _PointToPoint__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PointToPoint */ "./extensions/ModelAlignment/PointToPoint.js");
/* harmony import */ var _AngleToAngle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AngleToAngle */ "./extensions/ModelAlignment/AngleToAngle.js");
/* harmony import */ var _ModelSelector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ModelSelector */ "./extensions/ModelAlignment/ModelSelector.js");
/* harmony import */ var _TransformEdit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TransformEdit */ "./extensions/ModelAlignment/TransformEdit.js");
/* harmony import */ var _ModelTransformTool__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ModelTransformTool */ "./extensions/ModelAlignment/ModelTransformTool.js");
/* harmony import */ var _ModelAlignmentLocales__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ModelAlignmentLocales */ "./extensions/ModelAlignment/ModelAlignmentLocales.js");
...
ModelAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(ModelAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(ModelAlignmentExtension);
  ...
  function ModelAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, ModelAlignmentExtension);
    ...
    _this.onStateChanged = _this.onStateChanged.bind(_assertThisInitialized(_this));
    _this.onDisplayUnitsChanged = _this.onDisplayUnitsChanged.bind(_assertThisInitialized(_this));

    // Cached fuzzy box in model coordinates. Note that these are not affected by any transform,
    // so we only have to compute them once, even if models are moved.
    _this.fuzzyBoxCache = {};

    // For animated flights to a selected model (considering latest transforms)
    _this.flyToAnim = null; // {AnimControl}
    _this.flyToDuration = 1.0;

    // reused FrustumIntersector
    _this.frustumIntersector = new Autodesk.Viewing.Private.FrustumIntersector();return _this;
                ...
                this.extendLocalization(_ModelAlignmentLocales__WEBPACK_IMPORTED_MODULE_7__.locales);_context.next = 3;return _get(_getPrototypeOf(ModelAlignmentExtension.prototype), "load", this).call(this);case 3:



                this.unitHandler = new Autodesk.Edit2D.DefaultUnitHandler(this.viewer);

                this.panel = new _ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"](this.viewer, 'ModelAlignmentPanel', 'Model Alignment', this.unitHandler);
                ...
                // Update panel values if display unit change
                this.viewer.addEventListener(av.MeasureCommon.Events.DISPLAY_UNITS_CHANGED, this.onDisplayUnitsChanged);

                // bind it so that we can use it for event listeners
                this.onModelPanelSelect = this.onModelPanelSelect.bind(this);
                this.pointToPoint = new _PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"](this.viewer, this.coordPicker, this.screenOverlay);
                this.angleToAngle = new _AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"](this.viewer, this.coordPicker, this.screenOverlay);

                this.modelSelector = new _ModelSelector__WEBPACK_IMPORTED_MODULE_4__["default"](this.viewer, function (model) {return _this2.isModelSelectable(model);});
                this.viewer.toolController.registerTool(this.modelSelector);

                // Connect tool animations to extension anim-end events
                this.pointToPoint.addEventListener(_PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"].Events.ANIMATION_ENDED, function () {return _this2.onAnimEnded();});
                this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.ANIMATION_ENDED, function () {return _this2.onAnimEnded();});

                // If models are disabled for editing, we still allow them for selection (to see their transform values and for finding them).
                // But, we use red hover-highlight, because they cannot be edited.
                this.modelSelector.setCustomHoverColors(function (model) {return _this2.isModelEditable(model) ? undefined : _this2.modelSelector.hoverColorNotSelectable;});
                ...
                this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.SAVE_BUTTON_PRESSED, this.onSaveButton);

                // Mark model as modified if transform was modified in the panel
                this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.MODEL_TRANSFORM_EDITED, function () {

                  _this2.positionEditInProgress = true;

                  // Convert to world units
                  var positionWorld = _this2.unitHandler.fromDisplayUnitsVec3(_this2.model.getUnitString(), _this2.panel.getPosition());

                  // apply edit values to model transform
                  _this2.transformEdit.update();
                  _this2.transformEdit.setPosition(positionWorld);
                  _this2.transformEdit.setRotationZ(_this2.panel.getRotation());
                  _this2.transformEdit.apply();

                  _this2.modified();

                  _this2.positionEditInProgress = false;
                ...
                this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TAB_CHANGED, this.onTabChanged);

                // Color applied to selected models in selection mode
                this.selectionColor = new THREE.Vector4(1, 1, 0, 0.25);

                // Handles numerical edits of current model transform
                this.transformEdit = new _TransformEdit__WEBPACK_IMPORTED_MODULE_5__["default"](this.viewer);case 26:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
...

    {
      ...
      this.viewer.removeEventListener(av.MeasureCommon.Events.DISPLAY_UNITS_CHANGED, this.onDisplayUnitsChanged);
    ...
    // set model to be aligned next
      ...
      this.transformEdit.setModel(model);
      ...
      // For models that cannot be edited, hide the transform gizmo
      if (model && !this.isModelEditable(model)) {var _this$modelTransformT;
        (_this$modelTransformT = this.modelTransformTool) === null || _this$modelTransformT === void 0 ? void 0 : _this$modelTransformT.setModel(null);
      }
    }

    // Can be called when hovering over a model-list UI to synchronize
    // hover highlighting in the graphics with the model under mouse.
    //
    // Note: 
    //  - If there are multiple 3D views of the same model urn, they are all highlighted together,
    //    because 3D alignment can only be edited once for the whole model file.
    //  - Always call with null afterwards - to reactivate the default object hover color
  }, { key: "setHoverHighlighting", value: function setHoverHighlighting(model) {
      this.modelSelector.setHoverHighlighting(model);
    } }, { key: "isAnimationActive", value: function isAnimationActive()
    ...
    // Called by UI if position was edited. Change is tracked (for saving) and model is immediately updated
    // Note that a model must be selected first.
    //
    //  @param {Vector3} position - In LMV display coordinates
  }, { key: "handlePositionEdit", value: function handlePositionEdit(position) {
      this.positionEditInProgress = true;

      // Convert to world units
      var positionWorld = this.unitHandler.fromDisplayUnitsVec3(this.model.getUnitString(), position);

      this.transformEdit.update();
      this.transformEdit.setPosition(positionWorld);
      this.transformEdit.apply();
      this.modified();

      this.positionEditInProgress = false;
    }

    // Called by UI if rotationZ was changed. 
    //  @param {number} degrees - CCW rotation angle around z-Axis
  }, { key: "handleRotationZEdit", value: function handleRotationZEdit(degrees) {
      this.transformEdit.update();
      this.transformEdit.setRotationZ(degrees);
      this.transformEdit.apply();
      this.modified();
    }

    // Get translation offset of selected model in LMV display coordinates. 
    // May return undefined if a model is neither passed nor selected.
    //
    //  @param {av.Model} [model] - allows to obtain values for other models than the selected one
  }, { key: "getEditPosition", value: function getEditPosition() {var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.model;

      if (!model) {
        return undefined;
      }

      // extract position from model transform
      var position = new THREE.Vector3();
      _TransformEdit__WEBPACK_IMPORTED_MODULE_5__["default"].readPlacementValues(model, position);

      // Convert to display units
      return this.unitHandler.toDisplayUnitsVec3(model.getUnitString(), position);
    }

    //  @param {av.Model} [model] Allows to obtain values for other models than the selected one
  }, { key: "getEditRotationZ", value: function getEditRotationZ() {var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.model;

      if (!model) {
        return undefined;
      }

      // extract rotation from model transfrom
      var rot = new THREE.Vector3();
      _TransformEdit__WEBPACK_IMPORTED_MODULE_5__["default"].readPlacementValues(model, undefined, rot);

      return rot.z;
    }

    // Called if a user canceled current edit session. In this case,
    // all locally modified models are reverted back to the "last saved" state.
  }, { key: "discardChanges", value: function discardChanges() {

      // Bring all model transforms back to the state at the beginning of the edit session.
      for (var key in this.pendingChanges) {
        // get pending change
        var change = this.pendingChanges[key];
        var model = change.model;

        var tf = this.getLastSavedPlacement(model);
        this.viewer.impl.setPlacementTransform(model, tf);
      }

      this.pendingChanges = {};
    }

    // List filenames for all models with pending changes
  }, { key: "getChangedModelNames", value: function getChangedModelNames() {
      return Object.values(this.pendingChanges).map(function (change) {
        var node = change.model.getDocumentNode();
        return node.getModelName();
      });
    }

    // Optional: A modelSelectionFilter indicates which models are selectable.
    // By default, all models are selectable.
    //
    // @param {function(av.Model)=>bool} [filter] - If specified, only models with filter(model)===true are selectable.
  }, { key: "setModelSelectionFilter", value: function setModelSelectionFilter(filter) {
      this.modelSelectionFilter = filter;
    }

    // Optional: If a model is rejected by this filter, it is still selectable (e.g. to fly to it or see its coordinates),
    //           but cannot be modified, i.e. transformTool will be disabled.
  }, { key: "setModelEditFilter", value: function setModelEditFilter(filter) {
      this.modelEditFilter = filter;
    }

    // Returns true unless selection is disabled by a optional filter.
  }, { key: "isModelSelectable", value: function isModelSelectable(model) {
      return !this.modelSelectionFilter || this.modelSelectionFilter(model);
    }

    // Returns true if model is not locked or disabled from editing by an optional filter.
  }, { key: "isModelEditable", value: function isModelEditable(model) {

      // Check custom filter
      if (this.modelEditFilter && !this.modelEditFilter(model)) {
        return false;
      }

      // Only allow editing if lockFlag is explicitly known as "false".
      //
      // Note: isLocked() may return undefined if the flag is not known yet. 
      //       However, usually the lockFlag is in memory anyway, because the
      //       alignment item was already fetched when loading the model.
      return this.isAlignmentLockedSync(model) === false;
    }

    // Set viewcube home camera to a top-view of the given model. Up-direction is matched 
    // with the current project-north vector of the model (considering latest transform)
  }, { key: "setHomeCameraTopView", value: function setHomeCameraTopView(model) {

      // compute aligned orthoview for this model
      var view = this.createStableModelOrthoView(model);

      // set as new home camera
      this.viewer.autocam.setHomeViewFrom(view);
    }

    // Modify position of currently selected model, so that it moves into the current view.
    // Should not be triggered while using PointToPoint or Rotation tool. 
  }, { key: "fitSelectedModelToView", value: function fitSelectedModelToView() {
      this.model && this.pointToPoint.fitModelToView(this.model);
      this.modified();
    }

    // Check if transform tool is currently dragging. This can be used for
    // UI performance optimizations, because there will be high-frequency-changes of the transform values. 
  }, { key: "isTransformToolDragging", value: function isTransformToolDragging() {
      return this.modelTransformTool.isDragging();
    }

    // Trigger animated transition to an aligned ortho-view of the given model
    //
    // Note: Triggering this function during an animation is currently only supported for rotations.
    //       Using it during Point-to-Point or fitModelToView() animation is currently not supported.
  }, { key: "flyToModel", value: function flyToModel() {var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.model;
      if (!model) {
        return;
      }

      // Determine the view that we want to fly to
      var view = this.createStableModelOrthoView(model);

      // Make sure that the final up-vector is matched exactly. 
      var worldUpAligned = false;
      this.flyToAnim = Autodesk.Viewing.Private.flyToView(this.viewer, view, this.flyToDuration, null, worldUpAligned);
    }

    // Check if the given model is visible.
    //  @param {av.Model} model     - the selected one by default
    //  @param {bool}     afterAnim - Only relevant if the model is currently animated: 
    //                                 - If false, we check visibility at current model position.
    //                                 - If true (default), we check expected visibility when the model animation finished.
    //
    // Note: afterAnim flag is currently only supported for rotation animations.
  }, { key: "isModelVisible", value: function isModelVisible() {var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.model;var afterAnimation = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      if (!model) {
        return false;
      }

      this.frustumIntersector.reset(this.viewer.impl.camera);

      // If the model is currently rotating and afterAnim is true, use the bbox
      // that the model will have at the end of the animation.
      var isAnimating = model === this.model && this.angleToAngle.isAnimationActive();
      var overridePlacement = afterAnimation && isAnimating && this.angleToAngle.animEndMatrix;

      // get (read-only) cached model-space fuzzyBox 
      var boxMs = this.getModelSpaceFuzzyBox(model);

      // Compute bbox in viewer space
      var pt = overridePlacement || model.getPlacementTransform();
      var negOffset = model.getGlobalOffset().clone().multiplyScalar(-1);
      var boxVs = boxMs.clone().applyMatrix4(pt).translate(negOffset);

      // Check if bbox is visible
      var cullResult = this.frustumIntersector.intersectsBox(boxVs);
      return cullResult !== Autodesk.Viewing.Private.FrustumIntersector.OUTSIDE;
    }

    // Returns the unitString of the unit in which coordinantes are displayed and edited, e.g. 'm' or 'ft'.
  }, { key: "getEditDisplayUnit", value: function getEditDisplayUnit() {
      return this.unitHandler.getMainDisplayUnit();
    }

    // Checks if the transform of the currently
    // selected model is is identical with the one of the given model.
    //
    // Used by UI for pre-checking if offering copy-from operation makes sense.
  }, { key: "isPlacementEqual", value: function isPlacementEqual(model) {
      if (!this.model) {
        return undefined;
      }

      var srcPt = model.getPlacementTransform();
      var dstPt = this.model.getPlacementTransform();
      return srcPt.equals(dstPt);
    }

    // Copies the placement values from 
  }, { key: "copyPlacementFrom", value: function copyPlacementFrom(model) {
      if (!this.model || this.isPlacementEqual(model)) {
        return false;
      }

      // copy placement
      var srcPt = model.getPlacementTransform();
      this.viewer.impl.setPlacementTransform(this.model, srcPt);
      this.modified();
    }
    ...
    // Get (cached) fuzzy box of a model in source-file coordinates (excluding any load-time or dynamic transforms) 
    // Return value must not be modified.
  }, { key: "getModelSpaceFuzzyBox", value: function getModelSpaceFuzzyBox(model) {

      // get box from cache
      var box = this.fuzzyBoxCache[model.id];

      // on first run, compute fuzzyBox and cache it
      if (!box) {
        box = model.getFuzzyBox({ ignoreTransforms: true, quantil: 0.9 });
        this.fuzzyBoxCache[model.id] = box;
      }

      return box;
    }

    // If no animation is running, it is identical with createModelOrthView - which configures the view for the current model placement.
    //
    // If the model is currently animated, flying to its current position makes little sense, because it will
    // already be gone when we get there. Therefore, we align to the model position at the animation end instead.
    //
    // TODO: We currently only support rotations.
  }, { key: "createStableModelOrthoView", value: function createStableModelOrthoView(model) {
      var isAnimating = model === this.model && this.angleToAngle.isAnimationActive();
      var overridePlacement = isAnimating && this.angleToAngle.animEndMatrix;
      return this.createModelOrthoView(model, overridePlacement);
    }

    // Compute an top ortho-view that is aligned with the given model. 
    //  @param {Model}   model
    //  @param {Matrix4} [overridePlacement] - By default, we compute the view for the current placement of the model.
    //                                         Optionally, the computation can be done while assuming another placementTransform. 
  }, { key: "createModelOrthoView", value: function createModelOrthoView(model, overridePlacement) {

      var box = this.getModelSpaceFuzzyBox(model);

      // compute top view in model-space
      var cam = this.viewer.getCamera();
      var modelNorth = new THREE.Vector3(0, 1, 0); // projectNorth in model-coords
      var view = Autodesk.Viewing.UnifiedCamera.getViewParamsFromBox(box, false, cam.aspect, modelNorth, cam.fov);

      // For model-alignment, ortho-cameras are more helpful
      view.isPerspective = false;

      // Preserve viewer worldUp
      view.worldup = cam.worldup.clone();

      // If an override-placement is used, compute the correpsonding modelToViewer transform
      var overrideMatrix = null;
      if (overridePlacement) {
        overrideMatrix = overridePlacement.clone();

        // subtract globalOffset, so that the matrix maps to viewer-coords 
        var offset = model.getGlobalOffset();
        overrideMatrix.elements[12] -= offset.x;
        overrideMatrix.elements[13] -= offset.y;
        overrideMatrix.elements[14] -= offset.z;
      }

      // transform home-view to world-coords. Note that modelToViewer may not exist for models without placement data.
      var modelToViewer = overrideMatrix || model.getModelToViewerTransform();
      modelToViewer && Autodesk.Viewing.UnifiedCamera.transformViewParams(view, modelToViewer);

      // For AutoCam home-views, we also need a pivot point. Otherwise it will keep the old one,
      // which will cause bad surprises when orbiting without zooming first.
      view.pivot = view.target.clone();
...

    {
      ...
      // PointToPoint
      if (selectedTabId === _ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].TabIds.PointToPoint) {
      ...
      // AngleToAngle
      if (selectedTabId === _ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].TabIds.AngleToAngle) {
    ...
    // Connects PointToPoint workflow with Alignment panel
      ...
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FROM_POINT_CHANGED, function (event) {return _this6.pointToPoint.setFrom(event.fromPoint);});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TO_POINT_CHANGED, function (event) {return _this6.pointToPoint.setTo(event.toPoint);});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.OFFSET_CHANGED, function (event) {return _this6.pointToPoint.setOffset(event.offset);});

      // Trigger tool to select from/to-point when pressing the corresponding button
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FROM_POINT_BUTTON_PRESSED, function () {return _this6.pointToPoint.startSelectFrom();});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TO_POINT_BUTTON_PRESSED, function () {return _this6.pointToPoint.startSelectTo();});

      // connect apply button
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.APPLY_PTP_PRESSED, function () {
        _this6.pointToPoint.apply(_this6.panel.model);
        _this6.modified();
      });

      // connect fitToView button
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FIT_TO_VIEW_BUTTON_PRESSED, function () {
        _this6.pointToPoint.fitModelToView(_this6.panel.model);
        _this6.modified();
      });

      // After picking a from/to point, fill in the values to the panel
      this.pointToPoint.addEventListener(_PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"].Events.FROM_POINT_SELECTED, function (event) {return _this6.panel.onFromSelected(event.point);});
      this.pointToPoint.addEventListener(_PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"].Events.FROM_POINT_HOVERED, function (event) {return _this6.panel.onFromHovered(event.point);});
      this.pointToPoint.addEventListener(_PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"].Events.TO_POINT_HOVERED, function (event) {return _this6.panel.onToHovered(event.point);});
      this.pointToPoint.addEventListener(_PointToPoint__WEBPACK_IMPORTED_MODULE_2__["default"].Events.TO_POINT_SELECTED, function (event) {return _this6.panel.onToSelected(event.point);});
    }
    ...
    // Connects AngleToAngle workflow with Alignment panel
      ...
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.MODEL_SELECTED, function () {return _this7.setModel(_this7.panel.model);});

      // Update from/to point indicators when they are changed in the panel
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.CENTER_CHANGED, function (event) {return _this7.angleToAngle.setCenter(event.center);});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FROM_ANGLE_CHANGED, function (event) {return _this7.angleToAngle.changeFromAngle(toRadians(event.angle));});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TO_ANGLE_CHANGED, function (event) {return _this7.angleToAngle.changeToAngle(toRadians(event.angle));});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.OFFSET_ANGLE_CHANGED, function (event) {return _this7.angleToAngle.changeOffset(toRadians(event.angle));});

      // Trigger tool to select center/fromAngle/toAngle when pressing the corresponding button
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.CENTER_BUTTON_PRESSED, function () {return _this7.angleToAngle.startSelectCenter();});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FROM_ANGLE_BUTTON_PRESSED, function () {return _this7.angleToAngle.startSelectFromAngle();});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TO_ANGLE_BUTTON_PRESSED, function () {return _this7.angleToAngle.startSelectToAngle();});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.FROM_EDGE_BUTTON_PRESSED, function () {return _this7.angleToAngle.startSelectFromAngleEdge();});
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.TO_EDGE_BUTTON_PRESSED, function () {return _this7.angleToAngle.startSelectToAngleEdge();});

      // connect apply button
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.APPLY_ATA_PRESSED, function () {
        _this7.angleToAngle.apply(_this7.panel.model);
        _this7.modified();
      });

      // After picking a from/to point, fill in the values to the panel
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.CENTER_HOVERED, function (event) {return _this7.panel.onCenterHovered(event.point);});
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.CENTER_SELECTED, function (event) {return _this7.panel.onCenterSelected(event.point);});
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.FROM_ANGLE_HOVERED, function (event) {return _this7.panel.onFromAngleHovered(event.angle);});
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.FROM_ANGLE_SELECTED, function (event) {return _this7.panel.onFromAngleSelected(event.angle);});
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.TO_ANGLE_HOVERED, function (event) {return _this7.panel.onToAngleHovered(event.angle);});
      this.angleToAngle.addEventListener(_AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"].Events.TO_ANGLE_SELECTED, function (event) {return _this7.panel.onToAngleSelected(event.angle);});
    } }, { key: "connectModelMoveTool", value: function connectModelMoveTool()

    {var _this8 = this;
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.EDIT_POSITION_PRESSED, function () {return _this8.viewer.toolController.activateTool(_this8.modelTransformTool.getName());});
    }
    ...
    // Connect modelSelectorTool with UI
      ...
      this.panel.addEventListener(_ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"].Events.SELECT_MODEL_PRESSED, function (event) {
        _this9.startModelSelector();
      });

      // After selecting a model, apply it to panel and placement tool
      this.modelSelector.addEventListener(_ModelSelector__WEBPACK_IMPORTED_MODULE_4__["default"].Events.MODEL_SELECTED, function (event) {
    ...
    // Triggered if placementTransform was changed for a model.
      ...
      // Update panel values as well. However, avoid circular update if transform change was
      // already caused by a value edit.
      if (!this.positionEditInProgress) {
        this.panel.updateTransformValues();
      }
    ...
    } }, { key: "onDisplayUnitsChanged", value: function onDisplayUnitsChanged()

    {
      this.panel.updateTransformValues();
    } }]);return ModelAlignmentExtension;}(_ModelAlignmentBase__WEBPACK_IMPORTED_MODULE_0__["default"]);


ModelAlignmentExtension.ToolModes = ToolModes;

namespace.ModelAlignment = ModelAlignmentExtension;
namespace.ModelAlignmentPanel = _ModelAlignmentPanel__WEBPACK_IMPORTED_MODULE_1__["default"];
namespace.AngleToAngle = _AngleToAngle__WEBPACK_IMPORTED_MODULE_3__["default"];
namespace.ModelSelector = _ModelSelector__WEBPACK_IMPORTED_MODULE_4__["default"];
namespace.ModelTransformTool = _ModelTransformTool__WEBPACK_IMPORTED_MODULE_6__["default"];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModelAlignmentBase),
/* harmony export */   "AlignmentChange": () => (/* binding */ AlignmentChange)
/* harmony export */ });
...
var Events = {
  ...
  ANIMATION_ENDED: "animationEnded" // triggered if a tool animation finished, e.g. Point2Point or RotationTool. 
};
...
var getViewablePartId = function getViewablePartId(model) {
  ...
  return model.is2d() ? docNode.name() : undefined;
};var
...
ModelAlignmentBase = /*#__PURE__*/function (_av$Extension) {_inherits(ModelAlignmentBase, _av$Extension);var _super = _createSuper(ModelAlignmentBase);
  ...
  function ModelAlignmentBase(viewer, options) {var _this;_classCallCheck(this, ModelAlignmentBase);
    ...
    // Optional axis array for the model transform tool. Use in order to limit the gizmo to specific axis.
    _this.modelTransformToolAxis = null;
    ...
    Autodesk.Viewing.EventDispatcher.prototype.apply(_assertThisInitialized(_this));return _this;
                ...
                this.syncedState = {};case 17:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "initTransformTool", value: function initTransformTool()


    {var _this2 = this;
      // create & register
      this.modelTransformTool = new _ModelTransformTool_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.viewer, this.name, this.modelTransformToolAxis);
      this.viewer.toolController.registerTool(this.modelTransformTool);

      // Mark model as edited when using the tool
      this.modelTransformTool.addEventListener(_ModelTransformTool_js__WEBPACK_IMPORTED_MODULE_0__["default"].Events.MODEL_MOVED, function () {
        _this2.modified();
      });
    ...
    // Save & clear all pending changes. Requires an alignment service.
  }, { key: "saveChanges", value: function () {var _saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var promises, key, _this$options$alignme, item, model, matrix, docNode, urn, viewablePartId, promise, results, success;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (

                this.options.alignmentService) {_context2.next = 3;break;}
                console.error('AlignmentService must be set for saving transforms');return _context2.abrupt("return",
                false);case 3:


                promises = [];_context2.t0 = regeneratorRuntime.keys(

                this.pendingChanges);case 5:if ((_context2.t1 = _context2.t0()).done) {_context2.next = 21;break;}key = _context2.t1.value;
                item = this.pendingChanges[key];if (
                item) {_context2.next = 10;break;}return _context2.abrupt("continue", 5);case 10:



                model = item.model;
                matrix = item.resetPlacement ? null : model.getPlacementTransform().clone();
                ...
                viewablePartId = getViewablePartId(model);
                ...
                promise = (_this$options$alignme = this.options.alignmentService) === null || _this$options$alignme === void 0 ? void 0 : _this$options$alignme.saveTransform(urn, viewablePartId, matrix);

                promises.push(promise);_context2.next = 5;break;case 21:


                // Reset pending changes
                this.pendingChanges = {};_context2.next = 24;return (

                  Promise.all(promises));case 24:results = _context2.sent;

                // If any of the requests failed for some reason, return false.
                success = results.every(function (res) {return res;});return _context2.abrupt("return",

                success);case 27:case "end":return _context2.stop();}}}, _callee2, this);}));function saveChanges() {return _saveChanges.apply(this, arguments);}return saveChanges;}()


    // Whether a model is locked for alignment
    //  @param {AlignmentService} alignmentService
    //  @param {Model} model
  }, { key: "isAlignmentLocked", value: function () {var _isAlignmentLocked = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(model) {var cachedFlag, as, docNode, urn, viewableName;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:

                // If result is already cached, use it.
                //
                // Note: Usually, the alignment item was already fetched on model load, so that
                //       the lockFlag is always in cache anyway. 
                cachedFlag = this.isAlignmentLockedSync(model);if (!(
                cachedFlag !== undefined)) {_context3.next = 3;break;}return _context3.abrupt("return",
                cachedFlag);case 3:


                // Make sure alignment service is available.
                as = this.options.alignmentService;if (
                as) {_context3.next = 7;break;}
                console.error('Alignment service must be set to check lock flag.');return _context3.abrupt("return",
                false);case 7:


                // Fetch alignment to get locked flag
                docNode = model.getDocumentNode();
                urn = docNode.getRootNode().urn();
                viewableName = model.is2d() ? docNode.name() : undefined;_context3.next = 12;return (
                  as.isAlignmentLocked(urn, viewableName));case 12:return _context3.abrupt("return", _context3.sent);case 13:case "end":return _context3.stop();}}}, _callee3, this);}));function isAlignmentLocked(_x) {return _isAlignmentLocked.apply(this, arguments);}return isAlignmentLocked;}()


    // Check alignment flag in sync. Note:
    //  - Unlike the async variant, this one might return undefined if locked flag is not known yet.
    //  - Since the alignment item is usually fetched during model loading anyway, it will usually be in memory.
  }, { key: "isAlignmentLockedSync", value: function isAlignmentLockedSync(model) {

      var docNode = model.getDocumentNode();
      var urn = docNode.getRootNode().urn();
      var viewableName = model.is2d() ? docNode.name() : undefined;

      var as = this.options.alignmentService;
      return as && as.getIsLocked(urn, viewableName);
    }
    ...
    // Return the placementTransform of a model that we would get based on last saved state.
  }, { key: "getLastSavedPlacement", value: function getLastSavedPlacement(model) {


      // Check if there is an alignment transform for this model.
      // Since model transforms are usually loaded with the model, the last saved transform must be in cache.
      var urn = model.getDocumentNode().getRootNode().urn();
      var lastSavedMatrix = this.options.alignmentService.getTransform(urn);
      if (lastSavedMatrix) {
        // If so, apply client scaling to obtain the model placement.
        return applyClientScaling(lastSavedMatrix, model);
      }

      // If alignmentTransform is null, there is no previously saved alignment transform
      // and we return the original file transform.
      return this.getOriginalFileTransform(model);
    }
    ...
    model) {var _this3 = this;
      ...
      if (model) {var _this$pendingChanges$;
        var key = this.getAlignmentItemKey(model);
        return Boolean((_this$pendingChanges$ = this.pendingChanges[key]) === null || _this$pendingChanges$ === void 0 ? void 0 : _this$pendingChanges$.resetPlacement);
      }
    ...
    // Invoked if a tool animation finished
  }, { key: "onAnimEnded", value: function onAnimEnded() {
      this.fireEvent({ type: Events.ANIMATION_ENDED });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModelAlignmentPanel)
/* harmony export */ });
...
/* harmony import */ var _TransformEdit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TransformEdit.js */ "./extensions/ModelAlignment/TransformEdit.js");
...
// Format numeric input to limit the number of digits while avoiding trailing zeros
// If parsing failed, reset to 0, because entering NaN values makes little sense.
var formatNumber = function formatNumber(value, precision) {
  var val = parseFloat(parseFloat(value).toFixed(precision)).toString();
  return isFinite(val) ? val : '0';
};

// reused tmp values
var _tmpPos = new THREE.Vector3();
var _tmpRot = new THREE.Vector3();var
...
ValueInput = /*#__PURE__*/function () {
  ...
  function ValueInput(parent, onInput) {var _this = this;var digits = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;_classCallCheck(this, ValueInput);
    ...
    val) {
      return formatNumber(val, this.digits);
...
ModelAlignmentPanel = /*#__PURE__*/function (_Autodesk$Viewing$UI$) {_inherits(ModelAlignmentPanel, _Autodesk$Viewing$UI$);var _super = _createSuper(ModelAlignmentPanel);
  ...
  function ModelAlignmentPanel(viewer, id, title, unitHandler, options) {var _this3;_classCallCheck(this, ModelAlignmentPanel);
    _this3 = _super.call(this, viewer.container, id, title, options);

    _this3.viewer = viewer;

    _this3.unitHandler = unitHandler;
    ...
    _this3.setPrecision(4);return _this3;
  }_createClass(ModelAlignmentPanel, [{ key: "addModelSection", value: function addModelSection(
    ...
    // Update item list in model-select combo-box
      ...
      items.forEach(function (item, index) {
        ...
        option.addEventListener('mouseenter', function () {return (0,_ModelSelector_js__WEBPACK_IMPORTED_MODULE_1__.rolloverModel)(_this5.viewer, item.model);});
        option.addEventListener('mouseleave', function () {return (0,_ModelSelector_js__WEBPACK_IMPORTED_MODULE_1__.rolloverModel)(_this5.viewer, null);});
    ...
    // Update precision for position/offset values. For angles, the number of digits is fixed to 2 digits.
  }, { key: "setPrecision", value: function setPrecision(precision) {

      this.position.digits = precision;
      this.offset.digits = precision;
      this.fromPoint.digits = precision;
      this.toPoint.digits = precision;
    ...
    // Update values in position/rotation UI elements based on model transform
  }, { key: "updateTransformValues", value: function updateTransformValues() {
      ...
      _TransformEdit_js__WEBPACK_IMPORTED_MODULE_2__["default"].readPlacementValues(this.model, _tmpPos, _tmpRot);

      // convert position to display units
      this.unitHandler.toDisplayUnitsVec3(this.model.getUnitString(), _tmpPos, _tmpPos);

      this.setPosition(_tmpPos);
      this.setRotation(_tmpRot.z);
...

    {
      ...
      // Do nothing if values are not fully specified
      if (!this.position.valid() || !this.rotation.valid()) {
        return;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "rolloverModel": () => (/* binding */ rolloverModel),
/* harmony export */   "default": () => (/* binding */ ModelSelector)
/* harmony export */ });
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}

var Events = {
  // event.model contains selected model (may be null when clicking without a model under mouse)
  MODEL_SELECTED: 'modelSelected',

  // Fired if the model under mouse changes during mouse move in the canvas.
  // Params:
  //  - event.model contains the model under mouse
  //  - event.modelBefore contains the previously hovered model
  // Both may be null.
...
var ModelSelector = /*#__PURE__*/function () {
  ...
  // @param {function(av.Model)=>bool} [modelFilter] - Optional: If specified, a model is only selectable if modelFilter(model) returns true. 
  function ModelSelector(viewer) {var modelFilter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;_classCallCheck(this, ModelSelector);

    this.viewer = viewer;

    Autodesk.Viewing.EventDispatcher.prototype.apply(this);

    // Colors for mouse-over highlighting. May be changed from outside.
    this.hoverColor = new THREE.Color(0.5, 0.5, 0.1);
    this.hoverColorNotSelectable = new THREE.Color(0.5, 0, 0); // Separate hover-color to indicate if a model is not selectable

    this.modelFilter = modelFilter;

    // Optional: Custom function to choose hover-color for each model
    this.getCustomHoverColor = null;
...

    {
      ...
      this.setHoverHighlighting(null);
    ...
    // Returns modelID under mouse or 0 if nothing is hit
      ...
      this.viewer.impl.renderer().idAtPixel(vpVec.x, vpVec.y, res);

      // If we have multiple models, we require the ID buffer.
      return res[1] ? res[1] : 0;
    }

    // Apply hover-highlighting (only) to the given model.
    //
    //  @param {Model|nukk} [model] - May be null to clear highlighting.
  }, { key: "setHoverHighlighting", value: function setHoverHighlighting(model) {

      if (model) {

        // Check highlighting color depending on whether model is selectable
        var isSelectable = !this.modelFilter || this.modelFilter(model);
        var hoverColor = isSelectable ? this.hoverColor : this.hoverColorNotSelectable;

        // Apply custom override color if wanted
        var customColor = this.getCustomHoverColor && this.getCustomHoverColor(model);
        if (customColor) {
          hoverColor = customColor;
        }

        // activate custom highlighting color
        this.viewer.impl.renderer().setRollOverHighlightColor(hoverColor);

        // highlighting model
        rolloverModel(this.viewer, model);
      } else {
        // clear viewer highlighting
    ...
    // Called during mouse-move in canvas. Makes sure that the hovered model is highlighted
    // and events are triggered whenever the model changes.
  }, { key: "setModelUnderMouse", value: function setModelUnderMouse() {var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

      // Always update highlighting here to make sure that actual highlighting is up to date.
      //
      // Note that we even do this even if the model didn't change: Since the highlighting state 
      // of the viewer can be arbitrarily changed by other code as well, we cannot safely assume
      // here that the viewer highlighting state is always in-sync with this.modelUnderMouse.
      this.setHoverHighlighting(model);

      // Update this.modelUnderMouse, but remember previous one
      var modelBefore = this.modelUnderMouse;
      this.modelUnderMouse = model;

      // Fire event if model under mouse changed
      var changed = modelBefore !== model;
      if (changed) {
        this.fireEvent({
          type: Events.MODEL_HOVERED,
    ...
    event, button) {
      ...
      // Ignore hit if excluded by the filter
      if (model && this.modelFilter && !this.modelFilter(model)) {
        model = null;
      }
    ...
    // Allows for overriding the hover-color for model under mouse
    //  @param {function(model)=>THREE.Color} getHoverColor
  }, { key: "setCustomHoverColors", value: function setCustomHoverColors(getCustomHoverColor) {
      this.getCustomHoverColor = getCustomHoverColor;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModelTransformTool)
/* harmony export */ });
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
var OverlayName = 'Autodesk.ModelAlignment_Gizmo';

var Events = {
  MODEL_MOVED: 'modelMoved', // repeatedly called during dragging
  DRAG_STARTED: 'dragStarted',
  DRAG_ENDED: 'dragEnded' // { moved: bool } - indicates whether model was actually dragged between dragStart/dragEnd
};
...
var ModelTransformTool = /*#__PURE__*/function () {
  ...
  function ModelTransformTool(viewer, id, includeAxis) {_classCallCheck(this, ModelTransformTool);
    ...
    // Create axis gizmo
    this.gizmo = new THREE.TransformControls(this.viewer.impl.camera, this.viewer.canvas, 'translate', includeAxis);
    ...
    // Indicates if dragging is in progress. Unlike this.gizmo.isDragging(), it is only true if the gizmo was actually hit on mouseDown
    this.dragging = false;

    // Used during drag events to check whether the model was actually changed between mouseDown and mouseUp
    this.moved = false;
    ...
    model, box, useLocalAxis) {
      ...
      this.gizmo.setSpace(useLocalAxis ? "local" : "world");
    ...
    // Init gizmo to be located at minPoint of the model box
      ...
      if (this.gizmo.space === 'local' && matrix) {
        this.gizmo.setRotation(this.tmpMatrix.extractRotation(matrix));
      }
    ...
    event) {
      ...
      if (moved) {
        ...
        this.fireEvent({ type: Events.MODEL_MOVED });

        // for dragEnd event: Remember that model was actually moved during drag
        this.moved = true;
      }
    ...
    event) {
      ...
      // Used in mouseUp handler to check if model was actually dragged.
      this.dragging = this.gizmo.onPointerDown(event);

      // Used to check whether model was actually dragged between mouseDown/mouseUp
      this.moved = false;

      // Only fire event if gizmo was actually hit
      if (this.dragging) {
        this.fireEvent({ type: Events.DRAG_STARTED });
      }
    ...
    event) {
      ...
      // Only fire event if the gizmo was actually hit at mouseDown. 
      if (this.dragging) {
        this.fireEvent({ type: Events.DRAG_ENDED, moved: this.moved });
      }

      // Reset drag-interaction state flags
      this.dragging = false;
      this.moved = false;
...
PointToPoint = /*#__PURE__*/function (_Autodesk$Edit3D$TwoP) {_inherits(PointToPoint, _Autodesk$Edit3D$TwoP);var _super = _createSuper(PointToPoint);
  ...
  function PointToPoint(viewer, coordPicker, screenOverlay) {var _this;_classCallCheck(this, PointToPoint);
    ...
    // Moves the given model, so that "from" point moves to "to" point
      ...
      return new Promise(function (resolve) {
        ...
        var onEnd = function onEnd(t) {
          ...
          _this2.fireEvent({ type: Events.ANIMATION_ENDED });
        };
    ...
    // Move model to the center of the current view
      ...
      var fromPoint = box.getCenter(tmpCenterTarget);
      ...
      var dir = cam.getWorldDirection(tmpTarget);
      ...
      var maxDist = 2.0 * box.getSize(tmpTarget).length();
      if (moveDist > maxDist) {
      ...
      // Make sure that markers are hidden BEFORE setting the points. Otherwise, they would first show up
      // and fade out after setVisible().
      this.setVisible(false);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SheetAlignmentExtension)
/* harmony export */ });
...
/* harmony import */ var _ModelSheetTransition_BoundsPlane__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ModelSheetTransition/BoundsPlane */ "./extensions/ModelSheetTransition/BoundsPlane.js");
/* harmony import */ var _ModelAlignmentBase_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ModelAlignmentBase.js */ "./extensions/ModelAlignment/ModelAlignmentBase.js");
function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _get(target, property, receiver) {if (typeof Reflect !== "undefined" && Reflect.get) {_get = Reflect.get;} else {_get = function _get(target, property, receiver) {var base = _superPropBase(target, property);if (!base) return;var desc = Object.getOwnPropertyDescriptor(base, property);if (desc.get) {return desc.get.call(receiver);}return desc.value;};}return _get(target, property, receiver || target);}function _superPropBase(object, property) {while (!Object.prototype.hasOwnProperty.call(object, property)) {object = _getPrototypeOf(object);if (object === null) break;}return object;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = _getPrototypeOf(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}
...
var AnalyticsEventName = 'viewer.hypermodel.alignment';
...
var Events = {
  SURFACE_SELECTED: "surfaceSelected",
  SELECT_SHEET: "selectSheet",
  SHEET_ALIGNMENT_START: "sheetAlignmentStart",
  SHEET_ALIGNMENT_END: "sheetAlignmentEnd",
  SHEET_ALIGNMENT_SAVED: "sheetAlignmentSaved",
  SHEET_ALIGNMENT_SAVE_FAILED: "sheetAlignmentSaveFailed",
  CROP_CHANGED: "cropChanged",
  GIZMO_CHANGED: 'gizmoChanged' };


var SupportedExtensions = ['rvt', 'pdf', 'dwg', 'dwf', 'dwfx', 'dxf', 'dgn', 'tif', 'tiff', 'png', 'jpg', 'jpeg', 'bmp'];

var OverlayName = 'SheetAlignment_Extension_Overlay';

var DefaultPlaneWidth = 3; // meters
var DefaultPlaneHeight = 3; // meters
var EventThrottleDuration = 3000; // ms
var SheetAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(SheetAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(SheetAlignmentExtension);

  /**
                                                                                                                                                                                       * @param viewer
                                                                                                                                                                                       * @param options - options.hideSheet(model) - callback in order to hide sheet in case of cancel.
                                                                                                                                                                                                        - options.loadSheet(bubbleNode) - callback in order to load a sheet.
                                                                                                                                                                                       */
  function SheetAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, SheetAlignmentExtension);
    ...
    _this.onGizmoChanged = _this.onGizmoChanged.bind(_assertThisInitialized(_this));

    _this.fetchAndCacheVersionUrns = _this.fetchAndCacheVersionUrns.bind(_assertThisInitialized(_this));

    _this.fadeDuration = 0.3;

    _this.hoverColor = new THREE.Color(0.0, 0.5, 1.0);

    _this.modelTransformToolAxis = ['X', 'Y', 'XY'];

    _this.getVersionUrn = _this.options.getVersionUrn;

    _this.onCropThrottled = throttle(function (cropRegion) {
      _this.fireEvent({ type: Events.CROP_CHANGED, cropRegion: cropRegion });
    }, EventThrottleDuration);

    _this.onGizmoThrottled = throttle(function () {
      _this.fireEvent({ type: Events.GIZMO_CHANGED });
    }, EventThrottleDuration);return _this;
                ...
                this.cropExtension.addEventListener(Autodesk.Crop.Events.CROP_MODIFIED, this.onCropChanged);_context.next = 11;return (

                  this.viewer.loadExtension('Autodesk.AEC.ViewportsExtension'));case 11:this.viewportsExtension = _context.sent;
                ...
                this.modelTransformTool.addEventListener(Autodesk.ModelAlignment.ModelTransformTool.Events.MODEL_MOVED, this.onGizmoChanged);

                this.onSheetSelected = this.onSheetSelected.bind(this);
                this.onSurfacePicked = this.onSurfacePicked.bind(this);
                this.prepareForPickingSurface = this.prepareForPickingSurface.bind(this);
                ...
                this.boundsPlane = new _ModelSheetTransition_BoundsPlane__WEBPACK_IMPORTED_MODULE_3__["default"](this.viewer, OverlayName);

                // Only used the allowed cache if a versionUrn function was provided
                if (this.getVersionUrn) {
                  this.isLatestUrnCache = {};
                  this.viewer.addEventListener(Autodesk.Viewing.MODEL_ADDED_EVENT, this.fetchAndCacheVersionUrns);

                  this.fetchAndCacheVersionUrns();
                }case 28:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
...

    {
      ...
      if (this.getVersionUrn) {
        this.isLatestUrnCache = null;
        this.viewer.removeEventListener(Autodesk.Viewing.MODEL_ADDED_EVENT, this.fetchAndCacheVersionUrns);
      }
    }

    // Fetching of version urn is done to check if alignment is allowed in the context menu.
    // Since opening the menu is a sync operation, and getting the version is not, we fetch this info
    // as soon as possible to show the context menu action only if it's possible.
  }, { key: "fetchAndCacheVersionUrns", value: function fetchAndCacheVersionUrns() {var _this2 = this;
      var models = this.viewer.impl.get3DModels();
      models.forEach( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(model) {var key;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                  key = model.getModelKey();if (!(
                  _this2.isLatestUrnCache[key] === undefined)) {_context2.next = 5;break;}_context2.next = 4;return (
                    _this2.isAlignmentAllowed(model.getDocumentNode()));case 4:_this2.isLatestUrnCache[key] = _context2.sent;case 5:case "end":return _context2.stop();}}}, _callee2);}));return function (_x) {return _ref.apply(this, arguments);};}());


    }

    // Aligment is allowed only if the model is on the latest version
  }, { key: "isAlignmentAllowed", value: function () {var _isAlignmentAllowed = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(bubbleNode) {var currentUrn, lineage, latestUrn;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (
                bubbleNode) {_context3.next = 2;break;}return _context3.abrupt("return",
                false);case 2:if (


                this.getVersionUrn) {_context3.next = 5;break;}
                console.warn('getVersionUrn not provided to SheetAlignment extension');return _context3.abrupt("return",
                true);case 5:


                currentUrn = Autodesk.Viewing.fromUrlSafeBase64(bubbleNode.getRootNode().urn());
                lineage = bubbleNode.lineageUrn();_context3.prev = 7;_context3.next = 10;return (


                  this.getVersionUrn(lineage));case 10:latestUrn = _context3.sent;_context3.next = 16;break;case 13:_context3.prev = 13;_context3.t0 = _context3["catch"](7);

                console.error('getVersionUrn failed or canceled');case 16:return _context3.abrupt("return",


                currentUrn === latestUrn);case 17:case "end":return _context3.stop();}}}, _callee3, this, [[7, 13]]);}));function isAlignmentAllowed(_x2) {return _isAlignmentAllowed.apply(this, arguments);}return isAlignmentAllowed;}() }, { key: "setHasAlignPermission", value: function setHasAlignPermission(
    ...
    // Set initial sheet transform according to targetPos & targetNormal
      ...
      // get delta between current gizmo position and start position.
      var center = this.model.getBoundingBox(true, true).getCenter(new THREE.Vector3());

      var normal = this.targetNormal;

      // Add epsilon to prevent Z fighting once the sheet is on top of the face.
      var delta = this.targetPos.clone().sub(center).sub(normal.clone().multiplyScalar(EPSILON));
    ...
    // Set 2D model to be aligned next
      ...
      // This has to be first, before super.setModel, in order that the tool will get activated only after the model and default cropRegion is being set.
      this.cropExtension.setModel(model);

      _get(_getPrototypeOf(SheetAlignmentExtension.prototype), "setModel", this).call(this, model);
    } }, { key: "onSheetSelected", value: function () {var _onSheetSelected = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(

      urn, guid) {var model;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                  this.loadSheet(urn, guid));case 2:model = _context4.sent;if (


                model) {_context4.next = 6;break;}
                this.endAlignment(false);return _context4.abrupt("return");case 6:



                this.showSheet();case 7:case "end":return _context4.stop();}}}, _callee4, this);}));function onSheetSelected(_x3, _x4) {return _onSheetSelected.apply(this, arguments);}return onSheetSelected;}() }, { key: "showSheet", value: function () {var _showSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {var _this3 = this;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:



                this.clearSurfacePicking();

                this.waitingForPlacementApproval = false;

                this.boundsPlane.setVisible(false);

                this.clearHighlight();if (

                this.model) {_context5.next = 6;break;}return _context5.abrupt("return");case 6:
                ...
                this.viewer.impl.setDoNotCut(this.model, true);

                this.fourPointsAlignment.clear();

                this.fourPointsAlignment.attachPointsToModel(this.model, [0, 1]); // attach points 0 & 1 to model

                // Model should be loaded as hidden initially.
                // Only now after we set the placement of the model, show it.
                if (this.viewer.getVisibleModels().indexOf(this.model) === -1) {
                  this.viewer.showModel(this.model);
                }

                this.applyInitialSheetTransform();_context5.next = 14;return (

                  this.fitCameraToSheet());case 14:
                ...
                this.modelTransformTool.setModel(this.model, this.getMinCroppedBox(), true);

                this.viewer.impl.changePaperVisibility(this.model, false, true, function () {
                  _this3.startPointToPointSelection();

                  _this3.show();
                }, 1);case 16:case "end":return _context5.stop();}}}, _callee5, this);}));function showSheet() {return _showSheet.apply(this, arguments);}return showSheet;}() }, { key: "setTarget3DModel", value: function setTarget3DModel(
    ...
    targetModel) {
      ...
      if (this.target3DModel) {
        this.fourPointsAlignment.attachPointsToModel(targetModel, [2, 3]); // attach points 2 & 3 to model
      }
    } }, { key: "onSaveButton", value: function onSaveButton()
    ...
    // Applies point to point transform on the 2D sheet.
      ...
      var offset = (_this$targetNormal = this.targetNormal) === null || _this$targetNormal === void 0 ? void 0 : _this$targetNormal.clone().negate().multiplyScalar(EPSILON);
    ...
    model) {var _this$options$hideShe, _this$options;
      // Restore paper visibility.
      this.viewer.impl.changePaperVisibility(model, true);
      // Restore original transform.
      this.viewer.impl.setPlacementTransform(model, new THREE.Matrix4());

      (_this$options$hideShe = (_this$options = this.options).hideSheet) === null || _this$options$hideShe === void 0 ? void 0 : _this$options$hideShe.call(_this$options, model);
    } }, { key: "endAlignment", value: function endAlignment()

    {var isSaving = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;var hideModel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      this.hide();
      this.clearHighlight();
      ...
      this.setModel(null);
      this.setTarget3DModel(null);
      this.restoreToolbar();

      this.fireEvent({ type: Events.SHEET_ALIGNMENT_END, isSaving: isSaving, model: model });
    }

    // Clear all points and go back to surface picking step.
    // Start from previous surface visible.
  }, { key: "goBackToSurfacePicking", value: function goBackToSurfacePicking() {
      // Backup loaded sheet.
      var modelBackup = this.model;
      var bubbleNodeBackup = modelBackup === null || modelBackup === void 0 ? void 0 : modelBackup.getDocumentNode();
      var target3DModel = this.target3DModel;

      // Reset alignment.
      this.endAlignment();

      // If no original sheet is available, we are done.
      if (!bubbleNodeBackup) {
        return;
      }

      // Reload sheet and start alignment all over again, from surface picking step.
      this.prepareForPickingSurface(bubbleNodeBackup.urn(true), bubbleNodeBackup.guid());

      // Reselect bounds plane.
      this.setModel(modelBackup);
      this.setTarget3DModel(target3DModel);
      this.setBoundsPlane();
    }

    // Clear points on 3D model, and go back to point selection on the 2D sheet.
  }, { key: "goBackToPickPointsOnSheet", value: function goBackToPickPointsOnSheet() {
      this.fourPointsAlignment.cancelPointSelection();
      this.fourPointsAlignment.clearPoint(_FourPointsAlignment_js__WEBPACK_IMPORTED_MODULE_0__.FirstToIndex);
      this.fourPointsAlignment.clearPoint(_FourPointsAlignment_js__WEBPACK_IMPORTED_MODULE_0__.SecondToIndex);
      this.fourPointsAlignment.lastSelectedPoint = _FourPointsAlignment_js__WEBPACK_IMPORTED_MODULE_0__.SecondFromIndex;
      this.isolate2DSheet();
    }
    ...
    // Fit camera to 2D sheet.
  }, { key: "fitCameraToSheet", value: function fitCameraToSheet() {var _this4 = this;
      if (!this.model) {
        return;
      }
      ...
      var target = center;
      target.z -= bbox.getSize(new THREE.Vector3()).y;
      ...
      return new Promise(function (resolve) {
        Autodesk.Viewing.Private.flyToView(_this4.viewer, dstView, 0.5, resolve, false);
      });
    }
    ...
    {
      var bbox = this.getMinCroppedBox();
      this.modelTransformTool.setModel(this.model, bbox, true);

      var cropRegion = this.cropExtension.getCurrentCropRegion();
      this.modified(cropRegion);

      this.onCropThrottled(cropRegion);
    } }, { key: "onGizmoChanged", value: function onGizmoChanged()

    {
      this.onGizmoThrottled();
    } }, { key: "onPointSelectionStarted", value: function onPointSelectionStarted(_ref2)
    ...
    {var _this5 = this;
      ...
      this.coordPicker.setSnapFilter(function (snapResult) {return snapResult.modelId === _this5.model.id;});
    ...
    {var _this6 = this;
      ...
      this.coordPicker.setSnapFilter(function (snapResult) {return snapResult.modelId === _this6.target3DModel.id;});
    } }, { key: "clearIsolation", value: function clearIsolation()

    {
      this.animateModelVisibility(this.model, true);
      this.animateModelVisibility(this.target3DModel, true);
      this.coordPicker.setSnapFilter(null);
    } }, { key: "isAnimationActive", value: function isAnimationActive()
  ...
  }, { key: "animateModelVisibility2D", value: function animateModelVisibility2D(model, show) {var _model$visibilityMana;
      (_model$visibilityMana = model.visibilityManager) === null || _model$visibilityMana === void 0 ? void 0 : _model$visibilityMana.setAllVisibility(show);
    ...
    model, show) {var _this7 = this;
      if (show) {var _model$visibilityMana2;
        (_model$visibilityMana2 = model.visibilityManager) === null || _model$visibilityMana2 === void 0 ? void 0 : _model$visibilityMana2.setAllVisibility(true);
      }
      ...
      var onTimer = function onTimer(t) {
        ...
        _this7.viewer.impl.invalidate(true);
      };
      ...
      return new Promise(function (resolve) {
        var onFinished = function onFinished() {
          ...
          if (show) {
            restoreOriginal();
          } else {var _model$visibilityMana3;
            (_model$visibilityMana3 = model.visibilityManager) === null || _model$visibilityMana3 === void 0 ? void 0 : _model$visibilityMana3.setAllVisibility(false);
          }

          delete _this7.animationHandleMap[model.id];

          resolve();
        };

        _this7.animationHandleMap[model.id] = Autodesk.Viewing.Private.fadeValue(0, 1, _this7.fadeDuration, onTimer, onFinished);
      });
    }
    ...
    // Mirror sheet on X axis
      ...
      var size = this.model.getBoundingBox(true, true).getSize(new THREE.Vector3());
    ...
    menu, status) {var _intersection$model,_intersection$face,_this8 = this;
      if (!this.hasPermission) {
        return;
      }

      // Already in the middle of alignment process...
      if (this.waitingForPlacementApproval || this.fourPointsAlignment.hasAlignmentBackup() || this.fourPointsAlignment.isPickerActive()) {
        return;
      }
      ...
      var key = intersection.model.getModelKey();
      if (this.isLatestUrnCache && !this.isLatestUrnCache[key]) {
        return;
      }
      ...
      var menuEntry = {
        title: 'Align 2D drawing', // Gets translated inside ContextMenu.js
        target: function target() {
          _this8.surfacePreselected = true;
          _this8.onSurfacePicked({ point: point, normal: normal, modelId: model.id, dbId: intersection.dbId });
        } };
    ...
    /**
      ...
      */ }, { key: "saveChanges", value: function () {var _saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {var _model$getPlacementTr;var success, model, target3DModel, matrix, sheetNode, sheetUrn, sheetLineageUrn, sheetViewableName, target3DModelNode, target3DModelLineageUrn, cropRegion, regionId, modelSheetTransitionExtension;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:if (!(



                !this.model || !this.target3DModel)) {_context6.next = 2;break;}return _context6.abrupt("return");case 2:if (



                this.options.alignmentService) {_context6.next = 5;break;}
                console.error('AlignmentService must be set for saving transforms');return _context6.abrupt("return",
                false);case 5:


                success = true;
                // Save in case it changes while saving
                model = this.model;
                target3DModel = this.target3DModel;

                this.cropExtension.deactivate();
                this.viewer.toolController.deactivateTool(this.modelTransformTool.getName());

                // Clone is needed here in case that the placement transform is being changed until the async save operation is being executed.
                matrix = (_model$getPlacementTr = model.getPlacementTransform()) === null || _model$getPlacementTr === void 0 ? void 0 : _model$getPlacementTr.clone();

                sheetNode = model.getDocumentNode();
                sheetUrn = sheetNode.getRootNode().urn();
                sheetLineageUrn = sheetNode.lineageUrn();
                sheetViewableName = sheetNode.name();

                target3DModelNode = target3DModel.getDocumentNode();
                target3DModelLineageUrn = target3DModelNode.lineageUrn();
                ...
                regionId = model.regionId = model.regionId || (0,uuid__WEBPACK_IMPORTED_MODULE_2__.v4)();

                this.pendingChanges = [];

                this.endAlignment(true, false);

                // Viewport bounds (crop) were disabled due to disabling the crop tool (which is desired to remove the crop handles).
                // However, we do want to keep the viewport bounds for the 2D sheet, since it remains visible after saving.
                // model.setViewportBounds is the same API that is being used in ModelSheetTransition, when we show saved viewports.
                model.setViewportBounds(this.viewer.impl.matman(), cropRegion.bbox);

                // Since we are keeping the 2D sheet visible, it's equivalent to call ModelSheetTransition->showSheetAndSetTransform.
                // However, we can't use it directly, since we don't have a valid viewport yet.
                // The only missing part that we must copy from showSheetAndSetTransform, is adding the model to transformedModels map.
                // Otherwise, if the user will navigate to that 2D sheet afterwards, it won't get cleared inside resetModelIfNeeded.
                modelSheetTransitionExtension = this.viewer.getExtension('Autodesk.ModelSheetTransition');
                modelSheetTransitionExtension === null || modelSheetTransitionExtension === void 0 ? void 0 : modelSheetTransitionExtension.cache.transformedModels.set(model, model);

                // Save relationship of 2D region and 3D model.
                _context6.next = 26;return this.options.alignmentService.saveRelationship(
                target3DModelLineageUrn,
                target3DModelNode.name(),
                sheetLineageUrn,
                sheetViewableName,
                regionId);case 26:success = _context6.sent;_context6.t0 =



                success;if (!_context6.t0) {_context6.next = 32;break;}_context6.next = 31;return this.options.alignmentService.saveRegion(
                sheetUrn,
                sheetViewableName,
                regionId,
                cropRegion.bbox,
                matrix);case 31:_context6.t0 = _context6.sent;case 32:success = _context6.t0;


                if (success) {
                  this.viewportsExtension.fireEvent({
                    type: Autodesk.AEC.ViewportsExtension.Events.VIEWPORT_DATA_CREATED_EVENT,
                    models: [model, target3DModel] });


                  modelSheetTransitionExtension === null || modelSheetTransitionExtension === void 0 ? void 0 : modelSheetTransitionExtension.setSelectedViewport(regionId);

                  this.fireEvent({ type: Events.SHEET_ALIGNMENT_SAVED, regionId: regionId, model: model, target3DModel: target3DModel });
                } else {
                  this.hideModel(model);

                  this.fireEvent({ type: Events.SHEET_ALIGNMENT_SAVE_FAILED, regionId: regionId, model: model, target3DModel: target3DModel });
                }return _context6.abrupt("return",

                success);case 35:case "end":return _context6.stop();}}}, _callee6, this);}));function saveChanges() {return _saveChanges.apply(this, arguments);}return saveChanges;}() }, { key: "clearHighlight", value: function clearHighlight()


    {
      // Restore default hover color.
      this.viewer.impl.renderer().setRollOverHighlightColor();
      this.viewer.impl.pauseHighlight(false);
      this.viewer.impl.clearHighlight();
    } }, { key: "clearSurfacePicking", value: function clearSurfacePicking()

    {
      this.coordPicker.removeEventListener(Autodesk.Edit3D.CoordPicker.Events.POINT_CLICKED, this.onSurfacePicked);

      // Restore default cursor.
      this.coordPicker.setCursor();

      // Restore default coord picker behaviour - consumes click events.
      this.coordPicker.setConsumeClickEvents(true);
    ...
    /**
       * Fires the sheet selection event for the UI to open the sheet selection dialog
       * @param {boolean} isSurfaceSelected - true if the surface has been selected already before the sheet
       * @param {Autodesk.Viewing.Model} initialModel - model that will appear selected in the dialog
       */ }, { key: "selectSheet", value: function selectSheet(
    isSurfaceSelected) {var initialModel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.target3DModel;
      var file;

      if (initialModel) {
        var rootNode = initialModel.getDocumentNode().getRootNode();
        var sheetNodes = rootNode.search(Autodesk.Viewing.BubbleNode.SHEET_NODE);
        var has2DNodes = sheetNodes.length > 0;

        // In case that the 3D model has additional 2D sheets in its bubble,
        // hint the application to start picking the sheets from the same document.
        if (has2DNodes) {
          var urn = Autodesk.Viewing.fromUrlSafeBase64(rootNode.urn());
          var name = rootNode.getModelName();

          file = {
            urn: urn,
            bubbleUrn: urn, // Needed both urn & bubbleUrn for Alloy component...
            fileName: name };
      ...
      this.fireEvent({
        type: Events.SELECT_SHEET,
        file: file,
        onSheetSelected: this.prepareForPickingSurface,
        from: isSurfaceSelected ? 'Contextual' : 'Panel' });

    } }, { key: "onAlignmentStart", value: function onAlignmentStart()

    {
      this.coordPicker.setSelectionPlane(this.selectionPlane);

      var toolbar = this.viewer.getToolbar();
      var modelToolsGroup = toolbar === null || toolbar === void 0 ? void 0 : toolbar.getControl(Autodesk.Viewing.TOOLBAR.MODELTOOLSID);

      if (modelToolsGroup) {
        var children = modelToolsGroup.container.children;

        // Keep only the section tool button in the model-tools group toolbar.
        // Other tools from this group can cause confusion during alignment.
        for (var i = 0; i < children.length; i++) {
          if (children[i].id !== 'toolbar-sectionTool') {
            children[i].style.display = 'none';
          }
        }
      }

      // In case there is a visible sheet already in the viewer, hide it before the alignment starts.
      var modelSheetTransitionExtension = this.viewer.getExtension('Autodesk.ModelSheetTransition');
      modelSheetTransitionExtension === null || modelSheetTransitionExtension === void 0 ? void 0 : modelSheetTransitionExtension.hideSelectedSheet();

      this.fireEvent({ type: Events.SHEET_ALIGNMENT_START });
    } }, { key: "restoreToolbar", value: function restoreToolbar()

    {
      ...
      if (modelToolsGroup) {
        ...
        // Restore all of the toolbar groups that we hid before.
        for (var i = 0; i < children.length; i++) {
          children[i].style.display = '';
        }
      }
    } }, { key: "loadSheet", value: function () {var _loadSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(

      urn, guid) {var model;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:if (!(

                !urn || !guid)) {_context7.next = 2;break;}return _context7.abrupt("return",
                null);case 2:_context7.next = 4;return (


                  this.options.loadSheet(urn, guid));case 4:model = _context7.sent;

                this.setModel(model);return _context7.abrupt("return",

                model);case 7:case "end":return _context7.stop();}}}, _callee7, this);}));function loadSheet(_x5, _x6) {return _loadSheet.apply(this, arguments);}return loadSheet;}() }, { key: "setBoundsPlane", value: function setBoundsPlane()


    {var _this$model;
      var matrix = new THREE.Matrix4().makeTranslation(this.targetPos.x, this.targetPos.y, this.targetPos.z);

      var right = this.getRightVector(this.targetNormal);
      var up = right.cross(this.targetNormal).normalize();
      var orientation = new THREE.Matrix4().lookAt(new THREE.Vector3(), this.targetNormal, up);

      var metersToModel = Autodesk.Viewing.Private.convertUnits('m', this.target3DModel.getUnitString(), 1, 1);
      var sheetSize = (_this$model = this.model) === null || _this$model === void 0 ? void 0 : _this$model.getBoundingBox(true, true).getSize(new THREE.Vector3());
      var width = (sheetSize === null || sheetSize === void 0 ? void 0 : sheetSize.x) || DefaultPlaneWidth * metersToModel;
      var height = (sheetSize === null || sheetSize === void 0 ? void 0 : sheetSize.y) || DefaultPlaneHeight * metersToModel;
      var scale = new THREE.Matrix4().makeScale(width, height, 1);

      matrix.multiply(orientation).multiply(scale);

      this.boundsPlane.setFromMatrix(matrix);
      this.boundsPlane.setVisible(true);
    } }, { key: "onSurfacePicked", value: function onSurfacePicked(_ref3)

    {var point = _ref3.point,normal = _ref3.normal,modelId = _ref3.modelId;
      if (!point || !normal || !modelId) {
        return;
      }
      ...
      this.selectionPlane = new THREE.Plane();
      this.selectionPlane.setFromNormalAndCoplanarPoint(normal, point);

      this.targetPos = point;
      this.targetNormal = normal.negate();
      var model = this.viewer.impl.findModel(modelId);
      this.setTarget3DModel(model);

      this.setBoundsPlane();

      this.fireEvent({ type: Events.SURFACE_SELECTED });

      if (this.surfacePreselected) {
        // Only in case that the surface was picked from a contextual menu (right-click) - immediately call selectSheet.
        this.selectSheet(true);
      } else {
        this.startPickingSurface();
      }
    } }, { key: "prepareForPickingSurface", value: function prepareForPickingSurface(

    urn, guid) {
      if (!urn) {
        // In case that no urn is supplied, it means that no sheet was selected in the document selection modal.
        // In that case, clear the selected surface and quit.
        this.endAlignment(false);
      ...
      // Pre-fetch the sheet in the meantime
      this.loadSheet(urn, guid);

      this.surfacePreselected = false;

      this.startPickingSurface();
    } }, { key: "startPickingSurface", value: function startPickingSurface()

    {
      ...
      // When picking a surface, don't consume the click event, so it will be still possible to select an object during this phase.
      // It's important to allow object selection, in order to have the relevant options in the right click contextual menu, such as: section, isolate, hide selected, etc.
      this.coordPicker.setConsumeClickEvents(false);

      // Keep highlight (Usually coordPicker disables it)
      this.viewer.impl.pauseHighlight(false);

      // Turn snapper off for this picking session - don't worry, snapper will be back in the next time you'll use the coordPicker.
      this.coordPicker.snapperOff();

      // Change default coordpicker cursor. Usually it's crosshair.
      this.coordPicker.setCursor('pointer');

      // Clean previous selection planes.
      ...
      this.coordPicker.addEventListener(Autodesk.Edit3D.CoordPicker.Events.POINT_CLICKED, this.onSurfacePicked);

      this.waitingForPlacementApproval = true;
    }

    // Returns true when the 2D sheet is currently being loaded. Could be used to present a spinner.
  }, { key: "isSheetLoading", value: function isSheetLoading() {
      return this.waitingForPlacementApproval && this.target3DModel && !this.model;
    } }]);return SheetAlignmentExtension;}(_ModelAlignmentBase_js__WEBPACK_IMPORTED_MODULE_4__["default"]);


namespace.SheetAlignment = SheetAlignmentExtension;
namespace.Events = Events;
namespace.SupportedExtensions = SupportedExtensions;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "animateEdgeToEdge": () => (/* binding */ animateEdgeToEdge),
/* harmony export */   "animateMatrixToMatrix": () => (/* binding */ animateMatrixToMatrix)
/* harmony export */ });
/**
...
/***/ "./extensions/ModelAlignment/TransformEdit.js":
/*!****************************************************!*\
  !*** ./extensions/ModelAlignment/TransformEdit.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TransformEdit)
/* harmony export */ });
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
var avp = Autodesk.Viewing.Private;
...
var _tmpEuler = new THREE.Euler();

// Purpose is to facilitate editing of model placement transforms based
// on numerical input (usually obtained from UI)
var TransformEdit = /*#__PURE__*/function () {

  // @param {Viewer3D} viewer - Needed to make sure that events are fired on matrix changes
  function TransformEdit(viewer) {_classCallCheck(this, TransformEdit);
    this.model = null;

    // Decomposed representation of the transform
    this.position = new THREE.Vector3(); // in world-coordinates
    this.rotation = new THREE.Vector3(); // ccw Euler angles in degrees
    this.scale = new THREE.Vector3();

    // reused tmp values for matrix decompose
    this.quaternion = new THREE.Quaternion();
    this.euler = new THREE.Euler();

    this.viewer = viewer;
  }_createClass(TransformEdit, [{ key: "getPosition", value: function getPosition()

    {
      return this.position;
    } }, { key: "getRotationZ", value: function getRotationZ()

    {
      return this.rotation.z;
    }

    // Set translation offset. Note that positions are always in world-coordinates, i.e.
    //  - Offsets of different models in the view are comparable.
    //  - If a client uses unit scaling, position units may be different from model units
    //
    // @param {number} degrees - ccw angle around z-axis in degrees
  }, { key: "setPosition", value: function setPosition(pos) {
      this.position.copy(pos);
    }

    // @param {number} degrees - ccw angle around z-axis in degrees
  }, { key: "setRotationZ", value: function setRotationZ(degrees) {
      this.rotation.z = degrees;
    }

    // Set model that we are currently editing (may be null)
  }, { key: "setModel", value: function setModel(model) {
      this.model = model;
    }

    // Update position/rotation/scale from current model transform
    // Always call this before reading or modifying values.
  }, { key: "update", value: function update() {
      this.model && TransformEdit.readPlacementValues(this.model, this.position, this.rotation, this.scale);
    }

    // Update model placement based on current position/rotation/scale.
      ...
      this.euler._x = THREE.Math.degToRad(this.rotation.x);
      this.euler._y = THREE.Math.degToRad(this.rotation.y);
      this.euler._z = THREE.Math.degToRad(this.rotation.z);
      this.quaternion.setFromEuler(this.euler);

      // compose placementMatrix from panel values
      var newPlacement = new avp.LmvMatrix4(true).compose(this.position, this.quaternion, this.scale);
      this.viewer.impl.setPlacementTransform(this.model, newPlacement);
    }

    // Read UI placement values from model placement transform.
    //  @param {Vector3} [outPos]   - translation part of the matrix
    //  @param {Vector3} [outRot]   - rotation as euler angles in degrees
    //  @param {Vector3} [outScale] - scaling part
  }], [{ key: "readPlacementValues", value: function readPlacementValues(model, outPos, outRot, outScale) {

      var position = outPos || _tmpPos;
      var scale = outScale || _tmpScale;

      // get current placement (never null)
      var matrix = model.getPlacementTransform();

      // decompose into pos/scale/rotation
      THREE.Matrix4.prototype.decompose.call(matrix, position, _tmpQuat, scale); // Note that matrix.decompose would not exist on LmvMatrix4

      // get rotation as Euler angles
      _tmpEuler.setFromQuaternion(_tmpQuat);

      if (outRot) {
        outRot.x = THREE.Math.radToDeg(_tmpEuler._x);
        outRot.y = THREE.Math.radToDeg(_tmpEuler._y);
        outRot.z = THREE.Math.radToDeg(_tmpEuler._z);
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BoundsPlane)
/* harmony export */ });
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignment_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./ModelAlignment.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignment.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignment_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignment_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignment_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignment_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignmentPanel_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./ModelAlignmentPanel.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./extensions/ModelAlignment/ModelAlignmentPanel.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignmentPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignmentPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignmentPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ModelAlignmentPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
"use strict";
module.exports = JSON.parse('{"@@locale":"en","@@context":"SheetAlignment Extension","Align 2D drawing":"Align 2D drawing"}');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ModelAlignment": () => (/* reexport safe */ _ModelAlignment_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "SheetAlignment": () => (/* reexport safe */ _SheetAlignment_js__WEBPACK_IMPORTED_MODULE_1__["default"])
/* harmony export */ });
...
Autodesk.Extensions.ModelAlignment = __webpack_exports__;
/******/ })()
;
