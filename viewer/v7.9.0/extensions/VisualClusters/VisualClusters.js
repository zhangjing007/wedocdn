...
var buildClustersFromAttribute = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(models) {var attribName,clustersByName,promises,_loop,i,clusters,_args = arguments;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:attribName = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'Category';
            ...
            i) {
              ...
              Promise.all(promises));case 7:

            // Flatten to an array
            clusters = Object.values(clustersByName);return _context.abrupt("return",

            clusters);case 9:case "end":return _context.stop();}}}, _callee);}));return function buildClustersFromAttribute(_x) {return _ref.apply(this, arguments);};}();
...
/* harmony import */ var _Label3D__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Label3D */ "./extensions/VisualClusters/Label3D.js");
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
  ...
  function ClusterGizmoController(viewer) {_classCallCheck(this, ClusterGizmoController);
    ...
    sceneLayout) {var _this3 = this;
      ...
      i) {
        ...
        var label = new _Label3D__WEBPACK_IMPORTED_MODULE_0__["Label3D"](_this3.viewer, labelPos, text);
...
/***/ "./extensions/VisualClusters/Label3D.js":
/*!**********************************************!*\
  !*** ./extensions/VisualClusters/Label3D.js ***!
  \**********************************************/
/*! exports provided: worldToCanvas, Label3D */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "worldToCanvas", function() { return worldToCanvas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Label3D", function() { return Label3D; });
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
var av = Autodesk.Viewing;
var avp = Autodesk.Viewing.Private;

// Compute projection from 3D world pos to 2D canvas coords in pixels.
//  @param {Viewer3D} viewer
//  @param {Vector3}  worldPos
//  @param {Vector3}  [optionalTarget]
var worldToCanvas = function worldToCanvas(viewer, worldPos, optionalTarget) {

  var p = optionalTarget || new THREE.Vector3();

  // get camera and canvas bounds in pixels
  ...
  // get position in normalized device coords with xy in [-1, 1]^2
  p.copy(worldPos);
  p.applyProjection(matrix);

  // rescale xy to canvas bounds in pixels
  p.x = Math.round((p.x + 1) / 2 * containerBounds.width);
  p.y = Math.round((-p.y + 1) / 2 * containerBounds.height);
...
var getPixelDistance = function getPixelDistance(viewer, p1, p2) {
  ...
  var p1Screen = worldToCanvas(viewer, p1, tmpVec1);
  var p2Screen = worldToCanvas(viewer, p2, tmpVec2);
...
var Label3D = /*#__PURE__*/function () {
  ...
  function Label3D(viewer, pos3D) {var _this = this;var text = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '<Empty>';_classCallCheck(this, Label3D);
  ...
  _createClass(Label3D, [{ key: "shouldBeHidden", value: function shouldBeHidden() {
...

    {
      ...
      this.viewer.removeEventListener(av.cameraChangeCb);
    } }, { key: "update", value: function update()

    {
      // Get canvas position corresponding to this.pos3D
      var _worldToCanvas = worldToCanvas(this.viewer, this.pos3D, this.pos2D),x = _worldToCanvas.x,y = _worldToCanvas.y;
    ...
    // Fade out and dispose label when done
      ...
      window.setTimeout(function () {return _this2.dtor();}, 1000 * this.opacityParam.animTime);
    } }]);return Label3D;}();
...
var BoxAxes = /*#__PURE__*/function () {
  ...
  }, { key: "getBoundingRect", value: function getBoundingRect(outRect, matrix) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
        for (var _iterator = this.vertices[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var v = _step.value;
...
/* harmony import */ var _Label3D_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Label3D.js */ "./extensions/VisualClusters/Label3D.js");
/* harmony import */ var _ClusterGizmo_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ClusterGizmo.js */ "./extensions/VisualClusters/ClusterGizmo.js");
/* harmony import */ var _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./RotationAlignment.js */ "./extensions/VisualClusters/RotationAlignment.js");
...
var createDefaultLayout = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(models, alignShapeRotation) {var modelSupported, clusters, filter, rotationAlignment, shapeBoxes;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            // build clusters
            _context.next = 4;return Object(_Cluster_js__WEBPACK_IMPORTED_MODULE_0__["buildClustersFromAttribute"])(models);case 4:clusters = _context.sent;
            ...
            rotationAlignment = alignShapeRotation ? new _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__["RotationAlignment"](models) : null;

            // Create helper for bbox access
            shapeBoxes = new _ShapeBoxes_js__WEBPACK_IMPORTED_MODULE_3__["default"](models, rotationAlignment);

            // Compute layouts
            return _context.abrupt("return", Object(_RowLayoutBuilder_js__WEBPACK_IMPORTED_MODULE_1__["createClusterSetLayout"])(clusters, shapeBoxes, rotationAlignment));case 10:case "end":return _context.stop();}}}, _callee);}));return function createDefaultLayout(_x, _x2) {return _ref.apply(this, arguments);};}();
...
/**
                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                   * @constructor
                                                                                                                                                                                                                                                                  */var
VisualClustersExtension = /*#__PURE__*/function (_av$Extension) {_inherits(VisualClustersExtension, _av$Extension);
  function VisualClustersExtension(viewer, options) {var _this;_classCallCheck(this, VisualClustersExtension);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VisualClustersExtension).call(this, viewer, options));
    ...
    _this.gizmoController = new _ClusterGizmo_js__WEBPACK_IMPORTED_MODULE_6__["ClusterGizmoController"](_this.viewer);
  ...
  }_createClass(VisualClustersExtension, [{ key: "load", value: function load()
    ...
    active) {
      ...
      this.applyLayout();
    } }, { key: "applyLayout", value: function () {var _applyLayout = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var models, layoutTimeStamp, sceneLayout;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                ...
                layoutTimeStamp = this.layoutTimeStamp;_context2.next = 5;return (
                  createDefaultLayout(models, true));case 5:sceneLayout = _context2.sent;if (!(


                !this.layoutActive || layoutTimeStamp !== this.layoutTimeStamp)) {_context2.next = 8;break;}return _context2.abrupt("return");case 8:
                ...
                this.gizmoController.onLayoutChanged(this.sceneLayout);case 13:case "end":return _context2.stop();}}}, _callee2, this);}));function applyLayout() {return _applyLayout.apply(this, arguments);}return applyLayout;}() }, { key: "updateButton", value: function updateButton()
...

    {
      ...
      var tooltip = 'Form Clusters by test Category';
      if (disable) {
...
namespace.Label3D = _Label3D_js__WEBPACK_IMPORTED_MODULE_5__["Label3D"];
namespace.getBoxCorner = _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__["getBoxCorner"];
namespace.findAlignmentRotation = _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__["findAlignmentRotation"];
namespace.computeObjectAlignment = _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__["computeObjectAlignment"];
namespace.RotationAlignment = _RotationAlignment_js__WEBPACK_IMPORTED_MODULE_7__["RotationAlignment"];
