...
var Generator = function Generator() {
  ...
  this._prepare = function (font, pdfFontObj, option) {
    ...
    for (var key in font.glyphs.glyphs) {
      ...
      var _char = locateChar(glyph.unicode, pdfFontObj);
  ...
  this.createFontAtlasForPDF = function (page, cacheKey, option) {var _this4 = this;
    ...
    return this.readCache(cacheKey).then(function (data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        for (var fontKey in page.commonObjs.objs) {
          var f1 = page.commonObjs.objs[fontKey];
...
/**
                                  ...
                                  */var
MSDFExtension = /*#__PURE__*/function (_av$Extension) {_inherits(MSDFExtension, _av$Extension);

  function MSDFExtension(viewer, options) {_classCallCheck(this, MSDFExtension);return _possibleConstructorReturn(this, _getPrototypeOf(MSDFExtension).call(this,
    viewer, options));
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance");}function _iterableToArray(iter) {if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) {for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) {arr2[i] = arr[i];}return arr2;}}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _typeof(obj) {if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}(function (global, factory) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     */ }, { key: "rot", get: function get() {return this._rot;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */, set: function set(value) {if (this._rot !== value) {var tmp = this.width;this.width = this.height;this.height = tmp;this._rot = value;this._dirty++;}} }, { key: "data", get: function get() {return this._data;}, set: function set(value) {if (value === this._data) return;this._data = value;this._dirty++;} }, { key: "dirty", get: function get() {return this._dirty > 0;} }], [{ key: "Collide", value: function Collide(first, second) {return first.collide(second);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */ }, { key: "Contain", value: function Contain(first, second) {return first.contain(second);} }]);return Rectangle;}();var Bin = /*#__PURE__*/function () {function Bin() {_classCallCheck(this, Bin);this._dirty = 0;}_createClass(Bin, [{ key: "setDirty", /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @memberof Bin
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */value: function setDirty() {var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;this._dirty = value ? this._dirty + 1 : 0;if (!value) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {for (var _iterator = this.rects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var rect = _step.value;if (rect.setDirty) rect.setDirty(false);}} catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator["return"] != null) {_iterator["return"]();}} finally {if (_didIteratorError) {throw _iteratorError;}}}}} }, { key: "dirty", get: function get() {return this._dirty > 0 || this.rects.some(function (rect) {return rect.dirty;});} }]);return Bin;}();var
  MaxRectsBin = /*#__PURE__*/function (_Bin) {_inherits(MaxRectsBin, _Bin);
    function MaxRectsBin() {var _this;var maxWidth = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : EDGE_MAX_VALUE;var maxHeight = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EDGE_MAX_VALUE;var padding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { smart: true, pot: true, square: true, allowRotation: false, tag: false, border: 0 };_classCallCheck(this, MaxRectsBin);
      _this = _possibleConstructorReturn(this, _getPrototypeOf(MaxRectsBin).call(this));
      ...
      } }, { key: "repack", value: function repack()
      {
        ...
        this.rects.sort(function (a, b) {
          ...
          for (var _iterator2 = this.rects[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var rect = _step2.value;
            if (!this.place(rect)) {
              unpacked.push(rect);
            }
          }} catch (err) {_didIteratorError2 = true;_iteratorError2 = err;} finally {try {if (!_iteratorNormalCompletion2 && _iterator2["return"] != null) {_iterator2["return"]();}} finally {if (_didIteratorError2) {throw _iteratorError2;}}}
        for (var _i = 0, _unpacked = unpacked; _i < _unpacked.length; _i++) {var _rect = _unpacked[_i];
          this.rects.splice(this.rects.indexOf(_rect), 1);}
  ...
  OversizedElementBin = /*#__PURE__*/function (_Bin2) {_inherits(OversizedElementBin, _Bin2);
    function OversizedElementBin() {var _this3;_classCallCheck(this, OversizedElementBin);
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(OversizedElementBin).call(this));
      _this3.rects = [];
      if (arguments.length === 1) {
        if (_typeof(arguments.length <= 0 ? undefined : arguments[0]) !== 'object')
  ...
  MaxRectsPacker = /*#__PURE__*/function () {
    ...
    function MaxRectsPacker() {var width = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : EDGE_MAX_VALUE;var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EDGE_MAX_VALUE;var padding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { smart: true, pot: true, square: false, allowRotation: false, tag: false, border: 0 };_classCallCheck(this, MaxRectsPacker);
      ...
      {var quick = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
        if (quick) {
          var unpack = [];var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
            for (var _iterator3 = this.bins[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var bin = _step3.value;
              if (bin.dirty) {
                var up = bin.repack();
                if (up)
      ...
      {
        var allRects = [];var _iteratorNormalCompletion4 = true;var _didIteratorError4 = false;var _iteratorError4 = undefined;try {
          for (var _iterator4 = this.bins[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {var bin = _step4.value;
