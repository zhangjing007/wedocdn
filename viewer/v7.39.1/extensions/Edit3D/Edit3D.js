...
CoordPicker = /*#__PURE__*/function () {
  ...
  _createClass(CoordPicker, [{ key: "setSelectionPlane", value: function setSelectionPlane(plane) {
    ...
    // Returns hitPoint under mouse or null if no object under mouse.
      ...
      // When snapper is not active, perform a simple hit test.
      if (!this.snapperActive) {var _hitResult$face, _hitResult$model;
        var hitResult = this.viewer.impl.hitTest(event.canvasX, event.canvasY);
        point = hitResult === null || hitResult === void 0 ? void 0 : hitResult.point;

        // Extract normal
        if (hitResult === null || hitResult === void 0 ? void 0 : (_hitResult$face = hitResult.face) === null || _hitResult$face === void 0 ? void 0 : _hitResult$face.normal) {
          var mesh = this.viewer.impl.getRenderProxy(hitResult.model, hitResult.fragId);
        ...
        modelId = hitResult === null || hitResult === void 0 ? void 0 : (_hitResult$model = hitResult.model) === null || _hitResult$model === void 0 ? void 0 : _hitResult$model.id;
        dbId = hitResult === null || hitResult === void 0 ? void 0 : hitResult.dbId;

      } else if (this.snapper.isSnapped()) {
        // Get snapped position.
        var _hitResult = this.snapper.getSnapResult();
        point = Autodesk.Viewing.MeasureCommon.getSnapResultPosition(_hitResult, this.viewer);
        normal = _hitResult === null || _hitResult === void 0 ? void 0 : _hitResult.faceNormal;
        modelId = _hitResult === null || _hitResult === void 0 ? void 0 : _hitResult.modelId;
        dbId = _hitResult === null || _hitResult === void 0 ? void 0 : _hitResult.snapNode;
      }

      // If seleciton plane is set, project the hit point on the plane.
...
var NPointPicker = /*#__PURE__*/function () {
  function NPointPicker(viewer, coordPicker, screenOverlay, N) {var _this = this;var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};_classCallCheck(this, NPointPicker);
    ...
    gizmo, visible) {
      if (visible) {
        // Showing should happen immediately.
        this.screenOverlay.setGizmoVisible(gizmo, true);
      } else {
    ...
    // Show dashed line or arrow if from/to are both valid
      ...
      for (var _i2 = 0; _i2 < this.connectors.length; _i2++) {
        ...
        this.updateGizmoVisibility(connector.gizmo, showGizmo);
    ...
    {var _this2 = this;
      ...
      setTimeout(function () {
        for (var i = 0; i < _this2.N; i++) {
          if (!_this2.pointValid[i]) {
            _this2.startSelectPoint(i, false);
            break;
          }
        }
      }, 1);
    ...
    // Could be also used in the future for limiting the snapper to snap only on the attached model.
  }, { key: "setModelsToPointsMap", value: function setModelsToPointsMap(map) {var _this3 = this;
      ...
      if (ids.length > 0) {
        ids.forEach(function (id) {var _model$getModelTransf;
          var model = _this3.viewer.impl.findModel(Number(id), true);
          ...
          _this3.modelsToPointsMap[id].matrix = matrix || new Autodesk.Viewing.Private.LmvMatrix4(true);
        });
