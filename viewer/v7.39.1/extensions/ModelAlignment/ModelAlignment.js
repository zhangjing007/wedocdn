...
/* harmony import */ var _TransformEdit_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TransformEdit.js */ "./extensions/ModelAlignment/TransformEdit.js");
/* harmony import */ var _ModelAlignmentLocales__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ModelAlignmentLocales */ "./extensions/ModelAlignment/ModelAlignmentLocales.js");
...
ModelAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(ModelAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(ModelAlignmentExtension);
  ...
  function ModelAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, ModelAlignmentExtension);
    ...
    _this.onDisplayUnitsChanged = _this.onDisplayUnitsChanged.bind(_assertThisInitialized(_this));return _this;
                ...
                this.extendLocalization(_ModelAlignmentLocales__WEBPACK_IMPORTED_MODULE_6__["locales"]);_context.next = 3;return _get(_getPrototypeOf(ModelAlignmentExtension.prototype), "load", this).call(this);case 3:



                this.unitHandler = new Autodesk.Edit2D.DefaultUnitHandler(this.viewer);

                this.panel = new _ModelAlignmentPanel_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.viewer, 'ModelAlignmentPanel', 'Model Alignment', this.unitHandler);
                ...
                this.modelSelector = new _ModelSelector_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.viewer, function (model) {return _this2.isModelSelectable(model);});
                ...
                this.transformEdit = new _TransformEdit_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.viewer);case 23:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    // May return undefined if no model is selected.
  }, { key: "getEditPosition", value: function getEditPosition() {

      // get current world position
      this.transformEdit.update();
      var position = this.transformEdit.getPosition();

      // Convert to display units
      return this.unitHandler.toDisplayUnitsVec3(this.model.getUnitString(), position);
    } }, { key: "getEditRotationZ", value: function getEditRotationZ()

    {
      this.transformEdit.update();
      return this.transformEdit.getRotationZ();
    }
    ...
    // all locally modified models are reverted back to the "last saved" state.
      ...
      for (var key in this.pendingChanges) {
        ...
        // Since model was edited, the previously saved transform must be in cache.
        // So, if alignmentTransform is null, there is no previously saved alignment transform and we reset to original file transform.
        var tf = this.options.alignmentService.getTransform(urn) || this.getOriginalFileTransform(model);
    ...
    // 
    // Note: That models can never be selected if the alignmentLocked flag is set in alignmentService,
    //       indpendent of the filter.
    //
    ...
    // Returns true if a model is neither locked for alignment nor disabled by selectionFilter.
  }, { key: "isModelSelectable", value: function isModelSelectable(model) {

      // Check custom filter
      if (this.modelSelectionFilter && !this.modelSelectionFilter(model)) {
        return false;
      }

      // Only allow selection if lockFlag is explicitly known as "false".
      //
...
namespace.ModelSelector = _ModelSelector_js__WEBPACK_IMPORTED_MODULE_4__["default"];
...
SheetAlignmentExtension = /*#__PURE__*/function (_ModelAlignmentBase) {_inherits(SheetAlignmentExtension, _ModelAlignmentBase);var _super = _createSuper(SheetAlignmentExtension);
  ...
  function SheetAlignmentExtension(viewer, options) {var _this;_classCallCheck(this, SheetAlignmentExtension);
    ...
    _this.modelTransformToolAxis = ['X', 'Y', 'XY'];return _this;
                ...
                this.startPickingSurface = this.startPickingSurface.bind(this);
                ...
                this.boundsPlane = new _ModelSheetTransition_BoundsPlane__WEBPACK_IMPORTED_MODULE_3__["default"](this.viewer, OverlayName);case 23:case "end":return _context.stop();}}}, _callee, this);}));function load() {return _load.apply(this, arguments);}return load;}() }, { key: "unload", value: function unload()
    ...
    } }, { key: "onSheetSelected", value: function () {var _onSheetSelected = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(

      urn, guid) {var model;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  this.loadSheet(urn, guid));case 2:model = _context2.sent;if (


                model) {_context2.next = 6;break;}
                this.cancel();return _context2.abrupt("return");case 6:



                this.showSheet();case 7:case "end":return _context2.stop();}}}, _callee2, this);}));function onSheetSelected(_x, _x2) {return _onSheetSelected.apply(this, arguments);}return onSheetSelected;}() }, { key: "showSheet", value: function () {var _showSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var _this$viewer$getExten,_this2 = this;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                ...
                this.model) {_context3.next = 5;break;}return _context3.abrupt("return");case 5:
                ...
                this.applyInitialSheetTransform();_context3.next = 13;return (

                  this.fitCameraToSheet());case 13:
                ...
                this.viewer.impl.changePaperVisibility(this.model, false, true, function () {
                  ...
                  _this2.show();
                }, 1);case 16:case "end":return _context3.stop();}}}, _callee3, this);}));function showSheet() {return _showSheet.apply(this, arguments);}return showSheet;}() }, { key: "setTarget3DModel", value: function setTarget3DModel(
    ...
    // Fit camera to 2D sheet.
  }, { key: "fitCameraToSheet", value: function fitCameraToSheet() {var _this3 = this;
      if (!this.model) {
        return;
      }
      ...
      return new Promise(function (resolve) {
        Autodesk.Viewing.Private.flyToView(_this3.viewer, dstView, 0.5, resolve, false);
      });
    }
    ...
    model, show) {var _this4 = this;
      ...
      return new Promise(function (resolve) {
        var onFinished = function onFinished() {
          ...
          delete _this4.animationHandleMap[model.id];

          resolve();
        };

        _this4.animationHandleMap[model.id] = Autodesk.Viewing.Private.fadeValue(0, 1, _this4.fadeDuration, onTimer, onFinished);
      });
    }
    ...
    menu, status) {var _intersection$model,_intersection$face,_this5 = this;
      ...
      var menuEntry = {
        ...
        target: function target() {return _this5.onSurfacePicked({ point: point, normal: normal, modelId: model.id, dbId: intersection.dbId });} };
    ...
    /**
      ...
      */ }, { key: "saveChanges", value: function () {var _saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var success, matrix, sheetNode, sheetUrn, sheetLineageUrn, sheetViewableName, target3DModelNode, target3DModelLineageUrn, cropRegion, regionId;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (!(



                !this.model || !this.target3DModel)) {_context4.next = 2;break;}return _context4.abrupt("return");case 2:if (



                this.options.alignmentService) {_context4.next = 5;break;}
                console.error('AlignmentService must be set for saving transforms');return _context4.abrupt("return",
                false);case 5:
                ...
                regionId = this.model.regionId = this.model.regionId || Object(uuid__WEBPACK_IMPORTED_MODULE_2__["v4"])();
                ...
                _context4.next = 22;return this.options.alignmentService.saveRelationship(
                target3DModelLineageUrn,
                target3DModelNode.name(),
                sheetLineageUrn,
                sheetViewableName,
                regionId);case 22:success = _context4.sent;_context4.t0 =



                success;if (!_context4.t0) {_context4.next = 28;break;}_context4.next = 27;return this.options.alignmentService.saveRegion(
                sheetUrn,
                sheetViewableName,
                regionId,
                cropRegion.bbox,
                matrix);case 27:_context4.t0 = _context4.sent;case 28:success = _context4.t0;return _context4.abrupt("return",


                success);case 30:case "end":return _context4.stop();}}}, _callee4, this);}));function saveChanges() {return _saveChanges.apply(this, arguments);}return saveChanges;}() }, { key: "clearHighlight", value: function clearHighlight()
...

    {
      ...
      var wasPickingSurface = this.isPickingSurface;

      this.isPickingSurface = false;

      return wasPickingSurface;
    }
    /**
    ...
    isSurfaceSelected) {var initialModel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.target3DModel;
      ...
      this.fireEvent({
        ...
        file: file,
        onSheetSelected: isSurfaceSelected ? this.onSheetSelected : this.startPickingSurface });

    } }, { key: "loadSheet", value: function () {var _loadSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(

      urn, guid) {var model;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:if (!(

                !urn || !guid)) {_context5.next = 2;break;}return _context5.abrupt("return",
                null);case 2:_context5.next = 4;return (


                  this.options.loadSheet(urn, guid));case 4:model = _context5.sent;

                this.setModel(model);return _context5.abrupt("return",

                model);case 7:case "end":return _context5.stop();}}}, _callee5, this);}));function loadSheet(_x3, _x4) {return _loadSheet.apply(this, arguments);}return loadSheet;}() }, { key: "setBoundsPlane", value: function setBoundsPlane()
    ...
    } }, { key: "onSurfacePicked", value: function onSurfacePicked(_ref2)

    {var point = _ref2.point,normal = _ref2.normal,modelId = _ref2.modelId;
      if (!point || !normal || !modelId) {
        return;
      }

      this.surfacePickedManually = this.clearSurfacePicking();
