...
ModelSheetTransitionExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(ModelSheetTransitionExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(ModelSheetTransitionExtension);
  ...
  function ModelSheetTransitionExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, ModelSheetTransitionExtension);
    ...
    if (!_this.cache.docAndTransforms) {
      _this.cache.docAndTransforms = new Map();
    }
...

    {
      ...
      return true;
                ...
                this.resetModelIfNeeded(model2D, resetTransformAndViewport);_context.next = 8;return (
                  ...
                  this.fetchViewportsForModel2D(model2D));case 8:_context.t1 = _yield$this$fetchView = _context.sent.viewports;_context.t0 = _context.t1 === null;if (_context.t0) {_context.next = 12;break;}_context.t0 = _yield$this$fetchView === void 0;case 12:if (!_context.t0) {_context.next = 16;break;}_context.t2 = void 0;_context.next = 17;break;case 16:_context.t2 = _yield$this$fetchView.length;case 17:_context.t3 = _context.t2;toolbarUIEnabled = _context.t3 > 0;
    ...
    } }, { key: "fetchViewportsForModel3DFromAECData", value: function fetchViewportsForModel3DFromAECData(

    model, key) {var _bubbleNode$getAecMod, _bubbleNode$getAecMod2, _this$cache$key$relat;
      var bubbleNode = model.getDocumentNode();
      var relatedViewports = (_bubbleNode$getAecMod = bubbleNode.getAecModelData()) === null || _bubbleNode$getAecMod === void 0 ? void 0 : (_bubbleNode$getAecMod2 = _bubbleNode$getAecMod.viewports) === null || _bubbleNode$getAecMod2 === void 0 ? void 0 : _bubbleNode$getAecMod2.filter(_AEC_common_AecModelData__WEBPACK_IMPORTED_MODULE_3__["default"].supports2DTo3DTransform);

      if (!relatedViewports || !relatedViewports.length) {
        return false;
      }

      (_this$cache$key$relat = this.cache[key].relatedViewports).push.apply(_this$cache$key$relat, _toConsumableArray(relatedViewports));

      return true;
    } }, { key: "fetchViewportsForModel3DFromService", value: function () {var _fetchViewportsForModel3DFromService = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(

      model, key) {var _this$cache$key$relat2;var bubbleNode, lineageUrn3D, viewableName3D, relationships, relatedViewports, i, relationship, relatedModel, _relatedModel$id$spli, _relatedModel$id$spli2, lineageUrn2D, rest, nameAndRegion, _nameAndRegion$split, _nameAndRegion$split2, name2D, regionId, versionUrn2D, versionUrn2DEncoded, viewport;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                bubbleNode = model.getDocumentNode();

                lineageUrn3D = bubbleNode.lineageUrn();
                viewableName3D = bubbleNode.name();_context3.prev = 3;_context3.next = 6;return (



                  this.service.getRelationships(Autodesk.AlignmentService.RelationshipEntityTypes.Model3D, lineageUrn3D, viewableName3D));case 6:relationships = _context3.sent;_context3.next = 13;break;case 9:_context3.prev = 9;_context3.t0 = _context3["catch"](3);

                console.warn('No relationship found. Error: ' + _context3.t0);return _context3.abrupt("return",
                false);case 13:


                relatedViewports = [];

                i = 0;case 15:if (!(i < relationships.length)) {_context3.next = 41;break;}
                ...
                relatedModel) {_context3.next = 21;break;}
                console.warn('Related model not found');return _context3.abrupt("continue", 38);case 21:_relatedModel$id$spli =
                ...
                nameAndRegion = rest.slice(Prefix.Name.length);_nameAndRegion$split =
                nameAndRegion.split(Prefix.Region), _nameAndRegion$split2 = _slicedToArray(_nameAndRegion$split, 2), name2D = _nameAndRegion$split2[0], regionId = _nameAndRegion$split2[1];

                // Given lineageUrn, get latest versionUrn.
                _context3.next = 26;return this.options.getVersionUrn(lineageUrn2D);case 26:versionUrn2D = _context3.sent;
                versionUrn2DEncoded = Autodesk.Viewing.Private.toUrlSafeBase64(versionUrn2D);_context3.next = 30;return (

                  this.service.loadRegion(versionUrn2DEncoded, name2D, regionId));case 30:viewport = _context3.sent;if (

                viewport) {_context3.next = 34;break;}
                console.warn('Viewport not found.', versionUrn2DEncoded, name2D, regionId);return _context3.abrupt("continue", 38);case 34:



                viewport.isFromService = true;
                viewport.urn = versionUrn2DEncoded;
                viewport.viewableName = name2D;

                relatedViewports.push(viewport);case 38:i++;_context3.next = 15;break;case 41:if (


                relatedViewports.length) {_context3.next = 43;break;}return _context3.abrupt("return",
                false);case 43:


                (_this$cache$key$relat2 = this.cache[key].relatedViewports).push.apply(_this$cache$key$relat2, relatedViewports);return _context3.abrupt("return",

                true);case 45:case "end":return _context3.stop();}}}, _callee3, this, [[3, 9]]);}));function fetchViewportsForModel3DFromService(_x, _x2) {return _fetchViewportsForModel3DFromService.apply(this, arguments);}return fetchViewportsForModel3DFromService;}() }, { key: "fetchViewportsForModel3D", value: function () {var _fetchViewportsForModel3D = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(
      ...
      model) {var key;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                ...
                this.cache[key]) {_context4.next = 6;break;}
                ...
                // Fetch viewport data from both AEC model data and service
                this.fetchViewportsForModel3DFromAECData(model, key);_context4.next = 6;return (
                  this.fetchViewportsForModel3DFromService(model, key));case 6:return _context4.abrupt("return",


                this.cache[key]);case 7:case "end":return _context4.stop();}}}, _callee4, this);}));function fetchViewportsForModel3D(_x3) {return _fetchViewportsForModel3D.apply(this, arguments);}return fetchViewportsForModel3D;}() }, { key: "addMarkersForModel", value: function () {var _addMarkersForModel = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(


      model) {var _this4 = this;var rootNode, vpMetadata, relatedViewports;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:if (!(
                !model.is3d() || this.modelsWithMarkers[model.getModelKey()])) {_context6.next = 2;break;}return _context6.abrupt("return");case 2:



                this.modelsWithMarkers[model.getModelKey()] = model;

                rootNode = model.getDocumentNode().getRootNode();_context6.next = 6;return (

                  this.fetchViewportsForModel3D(model));case 6:vpMetadata = _context6.sent;
                relatedViewports = vpMetadata.relatedViewports;

                relatedViewports.forEach(function (vp, index) {
                  var vpData;
                  ...
                  if (vp.isFromService) {
                    vpData = {
                      ...
                      model3D: model,
                      matrix: vp.transform,
                      region: vp.boundingBox,
                      getNode: function () {var _getNode = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {var _yield$_this4$getRela, bubbleNode;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (
                                    _this4.getRelatedModelNode(model, vp.urn, vp.viewableName));case 2:_yield$_this4$getRela = _context5.sent;bubbleNode = _yield$_this4$getRela.bubbleNode;return _context5.abrupt("return",
                                  bubbleNode);case 5:case "end":return _context5.stop();}}}, _callee5);}));function getNode() {return _getNode.apply(this, arguments);}return getNode;}(),

                      isMatrixInLocalCoords: false,
                      guid: vp.regionId,
                      name: vp.viewableName // No way to store region names yet in service
                    };
                  } else {
                    // Viewports originated from AecModelData. Support only viewports with modelToSheetTransform
                    ...
                    var node = geometries[0]; // Array should contain only a single item.
                    ...
                    vpData = {
                      ...
                      matrix: matrix,
                      region: region,
                      getNode: function getNode() {return node;},
                      isMatrixInLocalCoords: true,
                      setElevationFromLevel: function setElevationFromLevel(matrix) {
                        var aec = node.getAecModelData();
                        _this4.setElevationFromLevel(matrix, vp, aec);
                      },
                      guid: vp.viewportGuid,
                      name: node.name() // Revit extractor doesn't extract viewport names currently. Use sheet name for now.
                    };
                  }
                  ...
                  _this4.markers[vpData.name + index] = marker;
                });case 9:case "end":return _context6.stop();}}}, _callee6, this);}));function addMarkersForModel(_x4) {return _addMarkersForModel.apply(this, arguments);}return addMarkersForModel;}() }, { key: "removeMarkersForModel", value: function removeMarkersForModel(
    ...
    } }, { key: "showSheetAndSetTransform", value: function () {var _showSheetAndSetTransform = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(

      node, viewportGuid, model3D, isMatrixInLocalCoords) {var model, matrix, crop, _yield$this$getDocume, model3DMatrix;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:_context7.next = 2;return (
                  this.loadModel(node));case 2:model = _context7.sent;_context7.prev = 3;_context7.next = 6;return (



                  this.getDocumentAndTransform(model, viewportGuid));case 6:_yield$this$getDocume = _context7.sent;matrix = _yield$this$getDocume.matrix;crop = _yield$this$getDocume.crop;_context7.next = 16;break;case 11:_context7.prev = 11;_context7.t0 = _context7["catch"](3);

                console.error('Could not get transform');
                this.hideModel(node);return _context7.abrupt("return");case 16:



                if (isMatrixInLocalCoords) {
                ...
                this.showModel(node);return _context7.abrupt("return",

                model);case 24:case "end":return _context7.stop();}}}, _callee7, this, [[3, 11]]);}));function showSheetAndSetTransform(_x5, _x6, _x7, _x8) {return _showSheetAndSetTransform.apply(this, arguments);}return showSheetAndSetTransform;}() }, { key: "hideSelectedSheet", value: function hideSelectedSheet()
    ...
    // If this model was changed due to a transition, reset those changes
      ...
      return true;
    } }, { key: "fetchViewportsForModel2D", value: function () {var _fetchViewportsForModel2D = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(

      model) {var key;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
                key = model.getModelKey();if (

                this.cache[key]) {_context8.next = 6;break;}
                // Create initial cache that this model doesn't contain any alignments.
                // Will also prevent multiple calls to fetch viewports if we are already in the middle of fetch
                // (can happen since we can reach here from onToolbarCreated as well as from onModelAdded)
                this.cache[key] = {
                ...
                // Fetch viewport data from both AEC model data and service
                this.fetchViewportsFromAECData(model, key);_context8.next = 6;return (
                  this.fetchViewportsFromService(model, key));case 6:return _context8.abrupt("return",


                this.cache[key]);case 7:case "end":return _context8.stop();}}}, _callee8, this);}));function fetchViewportsForModel2D(_x9) {return _fetchViewportsForModel2D.apply(this, arguments);}return fetchViewportsForModel2D;}()


    // Fetches viewports for a model and save it in cache, using the provided service
  }, { key: "fetchViewportsFromService", value: function () {var _fetchViewportsFromService = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(model, key) {var _this$service, _this$cache$key$viewp;var documentNode, urn2D, viewableName2D, viewports;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:
                documentNode = model.getDocumentNode();
                urn2D = documentNode.getRootNode().urn();
                viewableName2D = documentNode.name();_context9.next = 5;return (_this$service =

                this.service) === null || _this$service === void 0 ? void 0 : _this$service.loadRegions(urn2D, viewableName2D);case 5:viewports = _context9.sent;if (!(

                !viewports || !viewports.length)) {_context9.next = 8;break;}return _context9.abrupt("return",
                false);case 8:


                viewports.forEach(function (viewport) {return viewport.isFromService = true;});

                (_this$cache$key$viewp = this.cache[key].viewports).push.apply(_this$cache$key$viewp, _toConsumableArray(viewports));return _context9.abrupt("return",

                true);case 11:case "end":return _context9.stop();}}}, _callee9, this);}));function fetchViewportsFromService(_x10, _x11) {return _fetchViewportsFromService.apply(this, arguments);}return fetchViewportsFromService;}()


    // Fetches viewports for a model and save it in cache, using AEC data
  }, { key: "fetchViewportsFromAECData", value: function fetchViewportsFromAECData(model, key) {var _this$cache$key$viewp2;
      ...
      var viewports = _AEC_common_AecModelData__WEBPACK_IMPORTED_MODULE_3__["default"].findViewportsOnSheet(model).filter(_AEC_common_AecModelData__WEBPACK_IMPORTED_MODULE_3__["default"].supports2DTo3DTransform);

      if (!viewports.length) {
        return false;
      }

      (_this$cache$key$viewp2 = this.cache[key].viewports).push.apply(_this$cache$key$viewp2, _toConsumableArray(viewports));
    ...
    // to AEC data (if supported and exists)
  }, { key: "getDocumentAndTransformFromService", value: function () {var _getDocumentAndTransformFromService = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(model2D, lineageUrn2D, viewableName2D, regionId, viewport) {var _relationship;var relationship, _yield$this$service$g, _yield$this$service$g2, relatedModel, _relatedModel$id$spli3, _relatedModel$id$spli4, lineageUrn3D, name3D, versionUrn3D, urn3DEncoded, nodePromise;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_context10.prev = 0;_context10.next = 3;return (



                  this.service.getRelationships(Autodesk.AlignmentService.RelationshipEntityTypes.Region, lineageUrn2D, viewableName2D, regionId));case 3:_yield$this$service$g = _context10.sent;_yield$this$service$g2 = _slicedToArray(_yield$this$service$g, 1);relationship = _yield$this$service$g2[0];_context10.next = 12;break;case 8:_context10.prev = 8;_context10.t0 = _context10["catch"](0);

                console.warn('No relationship found. Error: ' + _context10.t0);throw _context10.t0;case 12:
                ...
                relatedModel) {_context10.next = 15;break;}throw (
                ...
                // Given lineageUrn, get latest versionUrn.
                _context10.next = 19;return this.options.getVersionUrn(lineageUrn3D);case 19:versionUrn3D = _context10.sent;
                ...
                nodePromise = this.getRelatedModelNode(model2D, urn3DEncoded, name3D);return _context10.abrupt("return",

                nodePromise.then(function (res) {return _objectSpread(_objectSpread({},
                  res), {}, {
                    matrix: viewport.transform,
                    crop: viewport.boundingBox });}));case 24:case "end":return _context10.stop();}}}, _callee10, this, [[0, 8]]);}));function getDocumentAndTransformFromService(_x12, _x13, _x14, _x15, _x16) {return _getDocumentAndTransformFromService.apply(this, arguments);}return getDocumentAndTransformFromService;}() }, { key: "getDocumentAndTransform", value: function () {var _getDocumentAndTransform = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(



      model, vpGuid) {var vpMetadata, viewports, viewport, docAndTransform, documentNode, lineageUrn2D, viewableName2D, regionId;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.next = 2;return (
                  this.fetchViewportsForModel2D(model));case 2:vpMetadata = _context11.sent; // Should be cached by now (when creating UI)
                viewports = vpMetadata.viewports;
                viewport = vpGuid ?
                viewports.find(function (vp) {return vp.isFromService ? vp.regionId === vpGuid : vp.viewportGuid === vpGuid;}) :
                ...
                if (
                this.cache.docAndTransforms.has(viewport)) {_context11.next = 20;break;}if (!


                viewport.isFromService) {_context11.next = 17;break;}
                documentNode = model.getDocumentNode();
                lineageUrn2D = documentNode.lineageUrn();
                viewableName2D = documentNode.name();
                regionId = viewport.regionId;_context11.next = 14;return (
                  this.getDocumentAndTransformFromService(model, lineageUrn2D, viewableName2D, regionId, viewport));case 14:docAndTransform = _context11.sent;_context11.next = 19;break;case 17:

                // From AecModelData
                docAndTransform = this.getDocumentAndTransformFromAEC(model, viewport);
                docAndTransform.isMatrixInLocalCoords = true;case 19:


                this.cache.docAndTransforms.set(viewport, docAndTransform);case 20:return _context11.abrupt("return",


                this.cache.docAndTransforms.get(viewport));case 21:case "end":return _context11.stop();}}}, _callee11, this);}));function getDocumentAndTransform(_x17, _x18) {return _getDocumentAndTransform.apply(this, arguments);}return getDocumentAndTransform;}() }, { key: "getRelatedModelNode", value: function () {var _getRelatedModelNode = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(


      currentModel, urnToLoad, nameToLoad) {var doc, currentUrn;return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:


                currentUrn = currentModel.getDocumentNode().getRootNode().urn();

                // Document already loaded.
                if (!(urnToLoad === currentUrn)) {_context12.next = 5;break;}
                doc = currentModel.getDocumentNode().getDocument();_context12.next = 15;break;case 5:_context12.prev = 5;_context12.next = 8;return (


                  this.loadDocument(urnToLoad));case 8:doc = _context12.sent;_context12.next = 15;break;case 11:_context12.prev = 11;_context12.t0 = _context12["catch"](5);

                console.warn('Could not load related model', _context12.t0);return _context12.abrupt("return");case 15:return _context12.abrupt("return",




                { doc: doc, bubbleNode: this.getNode(doc, nameToLoad) });case 16:case "end":return _context12.stop();}}}, _callee12, this, [[5, 11]]);}));function getRelatedModelNode(_x19, _x20, _x21) {return _getRelatedModelNode.apply(this, arguments);}return getRelatedModelNode;}() }, { key: "getNode", value: function getNode(
...
SheetToModel = /*#__PURE__*/function () {
  function SheetToModel(extension) {_classCallCheck(this, SheetToModel);
    ...
    this.viewer = extension.viewer;
      ...
      model2D) {var docAndTfPromise, doc, bubbleNode, matrix, crop, isMatrixInLocalCoords, _yield$docAndTfPromis, model3D, modelToViewerTransform;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
                this.viewer.impl.is2d) {_context.next = 2;break;}return _context.abrupt("return");case 2:
                ...
                this.viewer.setNavigationLock(true);_context.next = 6;return (
                  ...
                  docAndTfPromise);case 9:_yield$docAndTfPromis = _context.sent;doc = _yield$docAndTfPromis.doc;bubbleNode = _yield$docAndTfPromis.bubbleNode;matrix = _yield$docAndTfPromis.matrix;crop = _yield$docAndTfPromis.crop;isMatrixInLocalCoords = _yield$docAndTfPromis.isMatrixInLocalCoords;_context.next = 23;break;case 17:_context.prev = 17;_context.t0 = _context["catch"](6);
                ...
                // Show the 3D model
                _context.next = 26;return this.ext.showModel(bubbleNode);case 26:model3D = _context.sent;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var ModelSheet3DMarker = /*#__PURE__*/function () {
  function ModelSheet3DMarker(vpData, extension, ui, isVisible) {_classCallCheck(this, ModelSheet3DMarker);
    ...
    this._getNode = this.vpData.getNode;
    this.name = vpData.name;
    this.ui = ui;
...

    {
      if (this.isSheetVisible) {
        ...
        this.showSheet();
                ...
                if (!this.nodePromise) {
                  this.nodePromise = this._getNode();
                }_context.next = 3;return (

                  this.nodePromise);case 3:return _context.abrupt("return", _context.sent);case 4:case "end":return _context.stop();}}}, _callee, this);}));function getNode() {return _getNode.apply(this, arguments);}return getNode;}() }, { key: "hideSheet", value: function () {var _hideSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var node;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (



                  this.getNode());case 2:node = _context2.sent;
                this.extension.hideModel(node);
                this.container.classList.remove('selected');
                this.isSheetVisible = false;case 6:case "end":return _context2.stop();}}}, _callee2, this);}));function hideSheet() {return _hideSheet.apply(this, arguments);}return hideSheet;}() }, { key: "showSheet", value: function () {var _showSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var node, model;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:



                this.extension.onMarkerSelected(this);
                this.container.classList.add('selected');
                this.isSheetVisible = true;_context3.next = 5;return (
                  this.getNode());case 5:node = _context3.sent;_context3.next = 8;return (
                  this.extension.showSheetAndSetTransform(node, this.vpData.guid, this.vpData.model3D, this.vpData.isMatrixInLocalCoords));case 8:model = _context3.sent;if (


                this.isSheetVisible) {_context3.next = 12;break;}
                this.extension.hideModel(node);return _context3.abrupt("return",
                null);case 12:return _context3.abrupt("return",


                model);case 13:case "end":return _context3.stop();}}}, _callee3, this);}));function showSheet() {return _showSheet.apply(this, arguments);}return showSheet;}() }, { key: "onGoToSheet", value: function () {var _onGoToSheet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var model;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
...

    {
      ...
      if (this.vpData.isMatrixInLocalCoords) {
...

    {
      ...
      if (this.vpData.setElevationFromLevel) {
        this.vpData.setElevationFromLevel(this.matrix);
      }
