...
var getRelationshipEntityId = function getRelationshipEntityId(lineageUrn, viewablePart, region) {
  return "".concat(lineageUrn, "?viewablePart=").concat(viewablePart).concat(region ? "&region=".concat(region) : '');
};
  ...
  function AlignmentServiceLS() {var _this;var localStorage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : avp.LocalStorage;_classCallCheck(this, AlignmentServiceLS);
    ...
    */ }, { key: "saveRelationship", value: function () {var _saveRelationship = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(
      modelLineageUrn, modelViewablePartId, sheetLineageUrn, sheetViewablePartId, regionId) {var sheetEntityId, modelEntityId, relationshipId, item;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
                ...
                return _context8.abrupt("return", this.saveItem(APIs.Relationship, relationshipId, undefined, item));case 5:case "end":return _context8.stop();}}}, _callee8, this);}));function saveRelationship(_x20, _x21, _x22, _x23, _x24) {return _saveRelationship.apply(this, arguments);}return saveRelationship;}()
  ...
  function AlignmentServiceNucleus() {var _this;var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, AlignmentServiceNucleus);
    ...
    // Only used for testing. In practice, alignment 
      ...
      versionUrn, viewablePartId, regionId, boundingBox, transform) {var alignedItemID, item, index;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
                ...
                // Note: If the server has changed meanwhile, we will overwrite it.
                //       Ideally, we should have some conflict handling workflow for this case.
                _context8.next = 11;return this.alignmentApi.saveItem(item);case 11:return _context8.abrupt("return", _context8.sent);case 12:case "end":return _context8.stop();}}}, _callee8, this);}));function saveRegion(_x14, _x15, _x16, _x17, _x18) {return _saveRegion.apply(this, arguments);}return saveRegion;}() }, { key: "loadRegions", value: function () {var _loadRegions = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(
      ...
      versionUrn, viewablePartId, regionId) {var regions, region;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_context10.next = 2;return (
                ...
                region || null);case 5:case "end":return _context10.stop();}}}, _callee10, this);}));function loadRegion(_x21, _x22, _x23) {return _loadRegion.apply(this, arguments);}return loadRegion;}() }, { key: "getRelationships", value: function () {var _getRelationships = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(


      type, lineageUrn, viewablePartId, regionId) {return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.next = 2;return (

                  this.relationshipApi.getRelationships(type, lineageUrn, viewablePartId, regionId));case 2:return _context11.abrupt("return", _context11.sent);case 3:case "end":return _context11.stop();}}}, _callee11, this);}));function getRelationships(_x24, _x25, _x26, _x27) {return _getRelationships.apply(this, arguments);}return getRelationships;}() }, { key: "saveRelationship", value: function () {var _saveRelationship = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(


      modelLineageUrn, modelViewablePartId, sheetLineageUrn, sheetViewablePartId, regionId) {return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:_context12.next = 2;return (

                  this.relationshipApi.saveRelationship(modelLineageUrn, modelViewablePartId, sheetLineageUrn, sheetViewablePartId, regionId));case 2:return _context12.abrupt("return", _context12.sent);case 3:case "end":return _context12.stop();}}}, _callee12, this);}));function saveRelationship(_x28, _x29, _x30, _x31, _x32) {return _saveRelationship.apply(this, arguments);}return saveRelationship;}()


    // Primarily for testing: Delete item from backend.
  }, { key: "deleteRelationship", value: function () {var _deleteRelationship = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(relationshipId) {return regeneratorRuntime.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:
                //TODO: Remove this warning if/when deleting a relationship becomes an option
                console.warn("Deleting relationship ".concat(relationshipId, ". Should be used for testing ONLY"));_context13.next = 3;return (
                  this.relationshipApi.deleteRelationship(relationshipId));case 3:return _context13.abrupt("return", _context13.sent);case 4:case "end":return _context13.stop();}}}, _callee13, this);}));function deleteRelationship(_x33) {return _deleteRelationship.apply(this, arguments);}return deleteRelationship;}() }, { key: "onError", value: function onError()
    ...
    // Primarily for testing: Delete item from backend.
  }, { key: "deleteItem", value: function () {var _deleteItem = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(versionUrn, partId) {var itemId, item;return regeneratorRuntime.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:

                // If item doesn't exist server-side, do nothing to avoid request error
                itemId = new _NucleusAlignmentAPI__WEBPACK_IMPORTED_MODULE_3__["AlignedItemID"](versionUrn, partId);_context14.next = 3;return (
                  this.cache.getItem(itemId));case 3:item = _context14.sent;if (
                item.existsOnServer()) {_context14.next = 6;break;}return _context14.abrupt("return");case 6:if (!





                item.isLocked) {_context14.next = 9;break;}_context14.next = 9;return (
                ...
                // Send delete request
                _context14.next = 12;return this.alignmentApi.deleteItem(itemId);case 12:return _context14.abrupt("return", _context14.sent);case 13:case "end":return _context14.stop();}}}, _callee14, this);}));function deleteItem(_x34, _x35) {return _deleteItem.apply(this, arguments);}return deleteItem;}() }]);return AlignmentServiceNucleus;}(_AlignmentService__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
var NucleusAlignmentAPI = /*#__PURE__*/function () {
  ...
  _createClass(NucleusAlignmentAPI, [{ key: "fetchItems", value: function () {var _fetchItems = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items) {var result, body, i, postFix, res, response, loadedItems, _i, alignedItemId, key, data, report, _i2, name, _data;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
    ...
    //       Setting the lockFlag requires a separate request to another endpoint.
                ...
                true);case 11:case "end":return _context2.stop();}}}, _callee2, this);}));function saveItem(_x2) {return _saveItem.apply(this, arguments);}return saveItem;}()
  ...
  {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},projectId = _ref.projectId,_ref$getAccessToken = _ref.getAccessToken,getAccessToken = _ref$getAccessToken === void 0 ? getDefaultToken : _ref$getAccessToken,_ref$docsEnv = _ref.docsEnv,docsEnv = _ref$docsEnv === void 0 ? '' : _ref$docsEnv,_ref$serviceBaseUrl = _ref.serviceBaseUrl,serviceBaseUrl = _ref$serviceBaseUrl === void 0 ? getDefaultServiceUrl(docsEnv) : _ref$serviceBaseUrl,_ref$serviceVersion = _ref.serviceVersion,serviceVersion = _ref$serviceVersion === void 0 ? "v2" : _ref$serviceVersion,_ref$onError = _ref.onError,onError = _ref$onError === void 0 ? null : _ref$onError;_classCallCheck(this, NucleusRelationshipAPI);
    ...
    this.url = this.serviceUrl + this.itemsEndPoint;
      ...
      type, lineageUrn, viewablePartId, regionId) {var _res$data;var id, idEncoded, postFix, res, relationships;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                this.onError();return _context.abrupt("return");case 9:
                ...
                // Even if there are no alignments at all, the return value should be an empty object at the minimum
                console.warn('Unepxected request response: relationships:search should get an empty array');return _context.abrupt("return");case 13:return _context.abrupt("return",



                relationships);case 14:case "end":return _context.stop();}}}, _callee, this);}));function getRelationships(_x, _x2, _x3, _x4) {return _getRelationships.apply(this, arguments);}return getRelationships;}() }, { key: "saveRelationship", value: function () {var _saveRelationship = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(
